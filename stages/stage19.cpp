...
struct CppCodegen {
    ...
    void emit_stmt(Stmt s, bool m) {
        {
            auto& _match_9 = s;
            if (_match_9._tag == "None") {
                int64_t noop = 0LL;
            }
            else if (std::holds_alternative<Stmt::ExprStmt>(_match_9._data)) {
                auto& _v = std::get<Stmt::ExprStmt>(_match_9._data);
                auto& expr = _v.expr;
                this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + ((*this).emit_expr(expr, m))) + std::string(";\n"));
            }
            else if (std::holds_alternative<Stmt::Let>(_match_9._data)) {
                auto& _v = std::get<Stmt::Let>(_match_9._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<Stmt::Const>(_match_9._data)) {
                auto& _v = std::get<Stmt::Const>(_match_9._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<Stmt::Return>(_match_9._data)) {
                auto& _v = std::get<Stmt::Return>(_match_9._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                {
                    auto& _match_10 = value;
            ...
            else if (std::holds_alternative<Stmt::If>(_match_9._data)) {
                auto& _v = std::get<Stmt::If>(_match_9._data);
            ...
            else if (std::holds_alternative<Stmt::While>(_match_9._data)) {
                auto& _v = std::get<Stmt::While>(_match_9._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
            ...
            else if (std::holds_alternative<Stmt::For>(_match_9._data)) {
                auto& _v = std::get<Stmt::For>(_match_9._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                {
                    auto& _match_12 = collection;
                    if (std::holds_alternative<Expr::Range>(_match_12._data)) {
                        auto& _v = std::get<Expr::Range>(_match_12._data);
                        auto& start = *_v.start;
                        auto& end = *_v.end;
            ...
            else if (std::holds_alternative<Stmt::Block>(_match_9._data)) {
                auto& _v = std::get<Stmt::Block>(_match_9._data);
            ...
            else if (std::holds_alternative<Stmt::Try>(_match_9._data)) {
                auto& _v = std::get<Stmt::Try>(_match_9._data);
            ...
            else if (std::holds_alternative<Stmt::Function>(_match_9._data)) {
                auto& _v = std::get<Stmt::Function>(_match_9._data);
                auto& name = _v.name;
                auto& params = _v.params;
            ...
            else if (std::holds_alternative<Stmt::Class>(_match_9._data)) {
                auto& _v = std::get<Stmt::Class>(_match_9._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).emit_class(name, body);
            }
            else if (std::holds_alternative<Stmt::Struct>(_match_9._data)) {
                auto& _v = std::get<Stmt::Struct>(_match_9._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).emit_class(name, body);
            }
            else if (std::holds_alternative<Stmt::Enum>(_match_9._data)) {
                auto& _v = std::get<Stmt::Enum>(_match_9._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& visibility = _v.visibility;
                (*this).emit_enum(name, variants);
            }
            else if (std::holds_alternative<Stmt::Match>(_match_9._data)) {
                auto& _v = std::get<Stmt::Match>(_match_9._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).emit_match_impl(expr, arm_patterns, arm_bodies, m);
            }
            else if (std::holds_alternative<Stmt::Namespace>(_match_9._data)) {
                auto& _v = std::get<Stmt::Namespace>(_match_9._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("// TODO: unsupported namespace\n"));
            }
            else if (std::holds_alternative<Stmt::Import>(_match_9._data)) {
                auto& _v = std::get<Stmt::Import>(_match_9._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("// TODO: unsupported import\n"));
            }
            else if (std::holds_alternative<Stmt::Break>(_match_9._data)) {
                auto& _v = std::get<Stmt::Break>(_match_9._data);
                auto& keyword = _v.keyword;
                this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("break;\n"));
            }
            else if (std::holds_alternative<Stmt::Continue>(_match_9._data)) {
                auto& _v = std::get<Stmt::Continue>(_match_9._data);
                auto& keyword = _v.keyword;
    ...
    void emit_function(Token name, std::vector<Param> params, TypeNode return_type, std::vector<Stmt> body) {
        ...
        for (auto& p : params) {
            ...
            {
                auto& _match_16 = p.param_type;
                if (std::holds_alternative<TypeNode::Dynamic>(_match_16._data)) {
        ...
        for (auto& m : methods) {
            {
                ...
                if (std::holds_alternative<Stmt::Function>(_match_25._data)) {
                    ...
                    for (auto& p : mparams) {
                        ...
                        {
                            auto& _match_26 = p.param_type;
                            if (std::holds_alternative<TypeNode::Dynamic>(_match_26._data)) {
                                (*this).add_dynamic_var(p.name.lexeme);
                            }
                            else {
                                int64_t noop = 0LL;
    ...
    std::string infer_expr_type(Expr e, std::vector<std::string> param_names, std::vector<std::string> param_types) {
        {
            auto& _match_27 = e;
            if (std::holds_alternative<Expr::Literal>(_match_27._data)) {
                auto& _v = std::get<Expr::Literal>(_match_27._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                    return std::string("int64_t");
            ...
            else if (std::holds_alternative<Expr::Variable>(_match_27._data)) {
            ...
            else if (std::holds_alternative<Expr::Binary>(_match_27._data)) {
                auto& _v = std::get<Expr::Binary>(_match_27._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<Expr::Call>(_match_27._data)) {
                auto& _v = std::get<Expr::Call>(_match_27._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                {
                    auto& _match_28 = callee;
            ...
            else if (std::holds_alternative<Expr::Vector>(_match_27._data)) {
                auto& _v = std::get<Expr::Vector>(_match_27._data);
                auto& elements = _v.elements;
...
struct Parser {
    ...
    Expr assignment() {
        ...
        if ((*this).match_any(std::vector{TK_EQUAL})) {
            Expr value = (*this).assignment();
            {
                ...
                else if (std::holds_alternative<Expr::Get>(_match_35._data)) {
                    auto& _v = std::get<Expr::Get>(_match_35._data);
                    auto& object = *_v.object;
                    auto& name = _v.name;
                    return Expr::make_Set(object, name, value);
                }
                else if (std::holds_alternative<Expr::Index>(_match_35._data)) {
                    auto& _v = std::get<Expr::Index>(_match_35._data);
                    auto& object = *_v.object;
                    auto& bracket = _v.bracket;
                    auto& index = *_v.index;
            ...
            if ((*this).match_any(std::vector{TK_PLUS_EQUAL, TK_MINUS_EQUAL, TK_STAR_EQUAL})) {
                ...
                {
                    auto& _match_36 = expr;
                    if (std::holds_alternative<Expr::Variable>(_match_36._data)) {
                    ...
                    else if (std::holds_alternative<Expr::Get>(_match_36._data)) {
                        auto& _v = std::get<Expr::Get>(_match_36._data);
                        auto& object = *_v.object;
                        auto& name = _v.name;
                        Expr bin = Expr::make_Binary(Expr::make_Get(object, name), op_token, rhs);
                        return Expr::make_Set(object, name, bin);
                    }
                    else if (std::holds_alternative<Expr::Index>(_match_36._data)) {
                        auto& _v = std::get<Expr::Index>(_match_36._data);
                        auto& object = *_v.object;
                        auto& bracket = _v.bracket;
                        auto& index = *_v.index;
    ...
    Expr finish_call(Expr callee) {
        {
            auto& _match_37 = callee;
            if (std::holds_alternative<Expr::Variable>(_match_37._data)) {
                auto& _v = std::get<Expr::Variable>(_match_37._data);
                auto& name = _v.name;
            ...
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).check(TK_IDENTIFIER) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                    ...
                    if ((*this).check(TK_IDENTIFIER) && (((*this).peek_at(1LL).token_type == TK_NEWLINE) || ((*this).peek_at(1LL).token_type == TK_DEDENT))) {
                        ...
                        {
                            auto& _match_38 = vtype;
                            if (std::holds_alternative<TypeNode::NullType>(_match_38._data)) {
                                is_unit_type = true;
                            }
                            else if (std::holds_alternative<TypeNode::Void>(_match_38._data)) {
                                is_unit_type = true;
                            }
                            else {
                                int64_t noop = 0LL;
...
void test_parser() {
    ...
    for (auto& stmt : stmts) {
        {
            auto& _match_39 = stmt;
            if (std::holds_alternative<Stmt::ExprStmt>(_match_39._data)) {
                auto& _v = std::get<Stmt::ExprStmt>(_match_39._data);
                auto& expr = _v.expr;
                {
                    auto& _match_40 = expr;
                    if (std::holds_alternative<Expr::Binary>(_match_40._data)) {
                        auto& _v = std::get<Expr::Binary>(_match_40._data);
                        auto& left = *_v.left;
                        auto& op = _v.op;
                        auto& right = *_v.right;
                        print((std::string("Binary: ") + op.lexeme));
                        {
                            auto& _match_41 = right;
                            if (std::holds_alternative<Expr::Binary>(_match_41._data)) {
                                auto& _v = std::get<Expr::Binary>(_match_41._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
