        ...
        for (const auto& stmt : stmts) {
            {
                ...
                if (std::holds_alternative<std::decay_t<decltype(_match_50)>::Extern>(_match_50._data)) {
...
struct Checker {
    ...
    bool types_compatible(const TypeNode& expected, const TypeNode& actual) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Array>(_match_52._data)) {
                ...
                {
                    const auto& _match_53 = a_inner;
                    if (std::holds_alternative<std::decay_t<decltype(_match_53)>::Auto>(_match_53._data)) {
                        {
                            ...
                            else if (std::holds_alternative<std::decay_t<decltype(_match_54)>::HashSet>(_match_54._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_54)>::HashSet>(_match_54._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_54)>::HashMap>(_match_54._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_54)>::HashMap>(_match_54._data);
                                auto& ek = *_v.key_type;
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Array>(_match_55._data)) {
                ...
                auto& e_inner = *_v.inner;
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Array>(_match_56._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_56)>::Array>(_match_56._data);
                        auto& a_inner = *_v.inner;
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Auto>(_match_58._data)) {
                return true;
            }
            else if (_match_58._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Dynamic>(_match_58._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_62)>::Float>(_match_62._data)) {
                a_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_62)>::Float32>(_match_62._data)) {
                a_is_float = true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_63)>::Str>(_match_63._data)) {
                {
                    const auto& _match_65 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_65)>::CString>(_match_65._data)) {
                        return true;
                    }
                    else {
                        /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_66)>::Nullable>(_match_66._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_66)>::Nullable>(_match_66._data);
                auto& inner = *_v.inner;
                {
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Ptr>(_match_68._data)) {
    ...
    std::string type_name(const TypeNode& t) {
        {
            const auto& _match_70 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Int>(_match_70._data)) {
                return std::string("int");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Float>(_match_70._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Str>(_match_70._data)) {
                return std::string("string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Bool>(_match_70._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Void>(_match_70._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Auto>(_match_70._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Dynamic>(_match_70._data)) {
                return std::string("dynamic");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::NullType>(_match_70._data)) {
                return std::string("null");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Custom>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Custom>(_match_70._data);
                auto& name = _v.name;
                auto& _ = _v.type_args;
                return name;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Array>(_match_70._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::HashSet>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::HashSet>(_match_70._data);
                auto& inner = *_v.inner;
                return ((std::string("set[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::HashMap>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::HashMap>(_match_70._data);
                auto& k = *_v.key_type;
                auto& v = *_v.value_type;
                return ((((std::string("map[") + ((*this).type_name(k))) + std::string(", ")) + ((*this).type_name(v))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Nullable>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Nullable>(_match_70._data);
                auto& inner = *_v.inner;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Float32>(_match_70._data)) {
                return std::string("float32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::USize>(_match_70._data)) {
                return std::string("usize");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::CString>(_match_70._data)) {
                return std::string("cstring");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Ptr>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Ptr>(_match_70._data);
                auto& inner = *_v.inner;
    ...
    TypeNode infer_type(const Expr& e) {
        {
            ...
            if (_match_71._tag == "None") {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Literal>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Literal>(_match_71._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                ...
                }
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_72)>::Str>(_match_72._data)) {
                        return TypeNode::make_Str();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_74 = rt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_74)>::Float>(_match_74._data)) {
                        return TypeNode::make_Float();
                    }
                    else {
                        /* pass */
                ...
                }
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_75)>::Int>(_match_75._data)) {
                        return TypeNode::make_Int();
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::This>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::This>(_match_71._data);
                auto& kw = _v.keyword;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::AddressOf>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::AddressOf>(_match_71._data);
                auto& expr = *_v.expr;
    ...
    TypeNode infer_call_type(const Expr& callee) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Get>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Get>(_match_77._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                return TypeNode::make_Auto();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::StaticGet>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::StaticGet>(_match_77._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                {
                    const auto& _match_78 = object;
                    if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Variable>(_match_78._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_78)>::Variable>(_match_78._data);
    ...
    void collect_decl(const Stmt& s) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Function>(_match_79._data)) {
    ...
    void check_stmt(const Stmt& s) {
        {
            const auto& _match_80 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_80)>::ExprStmt>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::ExprStmt>(_match_80._data);
                auto& expr = _v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Let>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Let>(_match_80._data);
                auto& name = _v.name;
                auto& var_type = _v.var_type;
                auto& initializer = _v.initializer;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Const>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Const>(_match_80._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Return>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Return>(_match_80._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                (*this).check_expr(value);
                {
                    const auto& _match_82 = this->current_return_type;
                    if (_match_82._tag == "None") {
                        /* pass */
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_82)>::Void>(_match_82._data)) {
                        {
                            const auto& _match_83 = value;
                            if (_match_83._tag == "None") {
                                /* pass */
                            }
                            else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::If>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::If>(_match_80._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::While>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::While>(_match_80._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
                (*this).check_expr(condition);
                (*this).check_stmt(body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::For>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::For>(_match_80._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                auto& is_ref = _v.is_ref;
                ...
                {
                    const auto& _match_84 = coll_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Array>(_match_84._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_84)>::Array>(_match_84._data);
                        auto& inner = *_v.inner;
                        item_type = inner;
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Block>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Block>(_match_80._data);
                auto& statements = _v.statements;
                (*this).push_scope();
                for (const auto& st : statements) {
                    (*this).check_stmt(st);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Function>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Function>(_match_80._data);
                auto& name = _v.name;
                auto& params = _v.params;
                auto& return_type = _v.return_type;
                auto& body = _v.body;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Class>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Class>(_match_80._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).check_class(name, body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Struct>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Struct>(_match_80._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                auto& struct_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Enum>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Enum>(_match_80._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& methods = _v.methods;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Match>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Match>(_match_80._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).check_expr(expr);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Try>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Try>(_match_80._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Namespace>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Namespace>(_match_80._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Import>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Import>(_match_80._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Break>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Break>(_match_80._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Continue>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Continue>(_match_80._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Pass>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Pass>(_match_80._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::CppBlock>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::CppBlock>(_match_80._data);
                auto& code = _v.code;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Extern>(_match_80._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_80)>::Extern>(_match_80._data);
                auto& header = _v.header;
                auto& link_lib = _v.link_lib;
                auto& types = _v.types;
                auto& functions = _v.functions;
    ...
    void check_class(const Token& name, const std::vector<Stmt>& body) {
        ...
        for (const auto& s : body) {
            {
                const auto& _match_85 = s;
                if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Function>(_match_85._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_85)>::Function>(_match_85._data);
                    auto& fname = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& fbody = _v.body;
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Let>(_match_85._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_85)>::Let>(_match_85._data);
                    auto& lname = _v.name;
                    auto& var_type = _v.var_type;
                    auto& initializer = _v.initializer;
                    auto& visibility = _v.visibility;
    ...
    void check_expr(const Expr& e) {
        {
            const auto& _match_86 = e;
            if (_match_86._tag == "None") {
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Variable>(_match_86._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Binary>(_match_86._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Unary>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Unary>(_match_86._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(right);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Logical>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Logical>(_match_86._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(left);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Grouping>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Grouping>(_match_86._data);
                auto& inner = *_v.inner;
                (*this).check_expr(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Call>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Call>(_match_86._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Assign>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Assign>(_match_86._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(value);
                if ((!(*this).resolve(name.lexeme))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Index>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Index>(_match_86._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::IndexSet>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::IndexSet>(_match_86._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Vector>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Vector>(_match_86._data);
                auto& elements = _v.elements;
                for (const auto& el : elements) {
                    (*this).check_expr(el);
                }
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Map>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Map>(_match_86._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Get>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Get>(_match_86._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Set>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Set>(_match_86._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(object);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::StaticGet>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::StaticGet>(_match_86._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Cast>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Cast>(_match_86._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Throw>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Throw>(_match_86._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Range>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Range>(_match_86._data);
                auto& start = *_v.start;
                auto& end = *_v.end;
                (*this).check_expr(start);
                (*this).check_expr(end);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Lambda>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Lambda>(_match_86._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                (*this).push_scope();
                for (const auto& p : params) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Own>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Own>(_match_86._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::AddressOf>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::AddressOf>(_match_86._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else {
...
struct Parser {
    ...
    std::string type_to_string(const TypeNode& t) {
        {
            const auto& _match_88 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Int>(_match_88._data)) {
                return std::string("int64_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Float>(_match_88._data)) {
                return std::string("double");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Str>(_match_88._data)) {
                return std::string("std::string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Bool>(_match_88._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Void>(_match_88._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Auto>(_match_88._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Custom>(_match_88._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_88)>::Custom>(_match_88._data);
                auto& name = _v.name;
                auto& type_args = _v.type_args;
                if ((static_cast<int64_t>(type_args.size()) > 0LL)) {
                    std::vector<std::string> ta = {};
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Array>(_match_88._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_88)>::Array>(_match_88._data);
                auto& inner = *_v.inner;
                return ((std::string("std::vector<") + ((*this).type_to_string(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Int8>(_match_88._data)) {
                return std::string("int8_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Int16>(_match_88._data)) {
                return std::string("int16_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Int32>(_match_88._data)) {
                return std::string("int32_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Float32>(_match_88._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::USize>(_match_88._data)) {
                return std::string("size_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::CString>(_match_88._data)) {
                return std::string("const char*");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Ptr>(_match_88._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_88)>::Ptr>(_match_88._data);
                auto& inner = *_v.inner;
    ...
    Expr finish_call(const Expr& callee) {
        {
            const auto& _match_92 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_92)>::Variable>(_match_92._data)) {
        ...
        while ((!(*this).check(TK_DEDENT)) && (!(*this).is_at_end())) {
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).is_function_start()) {
                    auto old = this->in_class_body;
                    this->in_class_body = true;
                    methods.push_back((*this).function_declaration(std::string("public"), false));
                    this->in_class_body = old;
                }
                else {
...
void test_parser() {
    ...
    for (const auto& stmt : stmts) {
        {
            const auto& _match_94 = stmt;
            if (std::holds_alternative<std::decay_t<decltype(_match_94)>::ExprStmt>(_match_94._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_94)>::ExprStmt>(_match_94._data);
                auto& expr = _v.expr;
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_95)>::Binary>(_match_95._data)) {
                        ...
                        {
                            const auto& _match_96 = right;
                            if (std::holds_alternative<std::decay_t<decltype(_match_96)>::Binary>(_match_96._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_96)>::Binary>(_match_96._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
