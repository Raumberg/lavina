...
struct Expr {
    ...
    std::string _tag;
    std::variant<Expr::None, Expr::Literal, Expr::Unary, Expr::Binary, Expr::Grouping, Expr::Variable, Expr::Assign, Expr::Logical, Expr::Call, Expr::Index, Expr::IndexSet, Expr::Vector, Expr::Map, Expr::Get, Expr::Set, Expr::StaticGet, Expr::This, Expr::Cast, Expr::Throw, Expr::Range, Expr::Lambda, Expr::Own, Expr::AddressOf> _data;
...
struct CppCodegen {
    ...
    void emit_class(const Token& name, const std::vector<Stmt>& body, const std::vector<std::string>& type_params) {
        ...
        for (const auto& st : body) {
            {
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_31)>::Let>(_match_31._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_31)>::Let>(_match_31._data);
                    auto& fname = _v.name;
                    auto& var_type = _v.var_type;
        ...
        if (has_init) {
            ...
            for (const auto& st : init_body) {
                {
                    const auto& _match_32 = st;
                    if (std::holds_alternative<std::decay_t<decltype(_match_32)>::ExprStmt>(_match_32._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_32)>::ExprStmt>(_match_32._data);
                        auto& expr = _v.expr;
                        {
                            const auto& _match_33 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_33)>::Set>(_match_33._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_33)>::Set>(_match_33._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    const auto& _match_34 = object;
                                    if (std::holds_alternative<std::decay_t<decltype(_match_34)>::This>(_match_34._data)) {
                                        auto& _v = std::get<std::decay_t<decltype(_match_34)>::This>(_match_34._data);
                                        auto& kw = _v.keyword;
                                        bool already = false;
        ...
        if (has_init) {
            ...
            for (const auto& st : init_body) {
                {
                    const auto& _match_35 = st;
                    if (std::holds_alternative<std::decay_t<decltype(_match_35)>::ExprStmt>(_match_35._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_35)>::ExprStmt>(_match_35._data);
                        auto& expr = _v.expr;
                        bool handled = false;
                        {
                            const auto& _match_36 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_36)>::Set>(_match_36._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_36)>::Set>(_match_36._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    const auto& _match_37 = object;
                                    if (std::holds_alternative<std::decay_t<decltype(_match_37)>::This>(_match_37._data)) {
                                        auto& _v = std::get<std::decay_t<decltype(_match_37)>::This>(_match_37._data);
                                        auto& kw = _v.keyword;
                                        {
                                            const auto& _match_38 = value;
                                            if (std::holds_alternative<std::decay_t<decltype(_match_38)>::Variable>(_match_38._data)) {
                                                auto& _v = std::get<std::decay_t<decltype(_match_38)>::Variable>(_match_38._data);
                                                auto& tok = _v.name;
    ...
    std::string infer_expr_type(const Expr& e, const std::vector<std::string>& param_names, const std::vector<std::string>& param_types) {
        {
            const auto& _match_40 = e;
            if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Literal>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Literal>(_match_40._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                    return std::string("int64_t");
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Variable>(_match_40._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Binary>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Binary>(_match_40._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Unary>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Unary>(_match_40._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                return (*this).infer_expr_type(right, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Grouping>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Grouping>(_match_40._data);
                auto& inner = *_v.inner;
                return (*this).infer_expr_type(inner, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Call>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Call>(_match_40._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                {
                    const auto& _match_41 = callee;
                    ...
                    else if (std::holds_alternative<std::decay_t<decltype(_match_41)>::StaticGet>(_match_41._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_41)>::StaticGet>(_match_41._data);
                        auto& object = *_v.object;
                        auto& name = _v.name;
                        {
                            const auto& _match_42 = object;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Vector>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Vector>(_match_40._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Map>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Map>(_match_40._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Cast>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Cast>(_match_40._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
    ...
    void emit_enum(const Token& name, const std::vector<EnumVariantNode>& variants, const std::vector<std::string>& type_params) {
        ...
        for (const auto& v : variants) {
            for (const auto& ft : v.types) {
                {
                    const auto& _match_43 = ft;
                    if (std::holds_alternative<std::decay_t<decltype(_match_43)>::Custom>(_match_43._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_43)>::Custom>(_match_43._data);
                        auto& n = _v.name;
                        auto& _ = _v.type_args;
                        if ((n == enum_name)) {
                            has_self_ref = true;
                        ...
                        for (int64_t bi = 0LL; bi < static_cast<int64_t>(arm.bindings.size()); bi++) {
                            if ((bi < static_cast<int64_t>(vinfo.field_names.size()))) {
                                ...
                                if ((bi < static_cast<int64_t>(vinfo.types.size()))) {
                                    {
                                        const auto& _match_46 = vinfo.types[bi];
    ...
    void emit_arm_body(const Stmt& arm_body, bool in_method) {
        {
            const auto& _match_47 = arm_body;
            if (std::holds_alternative<std::decay_t<decltype(_match_47)>::Block>(_match_47._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_47)>::Block>(_match_47._data);
                auto& stmts = _v.statements;
                for (const auto& st : stmts) {
    ...
    std::string generate(const std::vector<Stmt>& stmts) {
        for (const auto& stmt : stmts) {
            {
                const auto& _match_48 = stmt;
                if (std::holds_alternative<std::decay_t<decltype(_match_48)>::Extern>(_match_48._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_48)>::Extern>(_match_48._data);
                    auto& header = _v.header;
                    auto& link_lib = _v.link_lib;
                    auto& types = _v.types;
                    auto& functions = _v.functions;
        ...
        for (const auto& stmt : stmts) {
            {
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Extern>(_match_49._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_49)>::Extern>(_match_49._data);
                    auto& header = _v.header;
                    auto& link_lib = _v.link_lib;
                    auto& types = _v.types;
                    auto& functions = _v.functions;
...
struct Checker {
    ...
    bool types_compatible(const TypeNode& expected, const TypeNode& actual) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_50)>::Array>(_match_50._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_50)>::Array>(_match_50._data);
                auto& a_inner = *_v.inner;
                {
                    const auto& _match_51 = a_inner;
                    if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Auto>(_match_51._data)) {
                        {
                            const auto& _match_52 = expected;
                            ...
                            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::HashSet>(_match_52._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_52)>::HashSet>(_match_52._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::HashMap>(_match_52._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_52)>::HashMap>(_match_52._data);
                                auto& ek = *_v.key_type;
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_53)>::Array>(_match_53._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_53)>::Array>(_match_53._data);
                auto& e_inner = *_v.inner;
                {
                    const auto& _match_54 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_54)>::Array>(_match_54._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_54)>::Array>(_match_54._data);
                        auto& a_inner = *_v.inner;
        ...
        {
            const auto& _match_55 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Auto>(_match_55._data)) {
                return true;
            }
            else if (_match_55._tag == "None") {
                return true;
            }
        ...
        {
            const auto& _match_56 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Auto>(_match_56._data)) {
                return true;
            }
            else if (_match_56._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Dynamic>(_match_56._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        bool a_is_int = false;
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_57)>::Int>(_match_57._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_57)>::Int8>(_match_57._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_57)>::Int16>(_match_57._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_57)>::Int32>(_match_57._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_57)>::USize>(_match_57._data)) {
                e_is_int = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_58 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Int>(_match_58._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Int8>(_match_58._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Int16>(_match_58._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Int32>(_match_58._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_58)>::USize>(_match_58._data)) {
                a_is_int = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_59 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_59)>::Float>(_match_59._data)) {
                e_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_59)>::Float32>(_match_59._data)) {
                e_is_float = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_60 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Float>(_match_60._data)) {
                a_is_float = true;
            }
        ...
        {
            const auto& _match_61 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_61)>::CString>(_match_61._data)) {
                {
                    const auto& _match_62 = actual;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Str>(_match_61._data)) {
                {
                    const auto& _match_63 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_63)>::CString>(_match_63._data)) {
                        return true;
                    }
                    else {
                        /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_64)>::Nullable>(_match_64._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_64)>::Nullable>(_match_64._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_65 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_65)>::NullType>(_match_65._data)) {
                        return true;
                    }
                    else {
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_66)>::Ptr>(_match_66._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_66)>::Ptr>(_match_66._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_67 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_67)>::NullType>(_match_67._data)) {
                        return true;
                    }
                    else {
                        /* pass */
    ...
    std::string type_name(const TypeNode& t) {
        {
            const auto& _match_68 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Int>(_match_68._data)) {
                return std::string("int");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Float>(_match_68._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Str>(_match_68._data)) {
                return std::string("string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Bool>(_match_68._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Void>(_match_68._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Auto>(_match_68._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Dynamic>(_match_68._data)) {
                return std::string("dynamic");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::NullType>(_match_68._data)) {
                return std::string("null");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Custom>(_match_68._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_68)>::Custom>(_match_68._data);
                auto& name = _v.name;
                auto& _ = _v.type_args;
                return name;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Array>(_match_68._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_68)>::Array>(_match_68._data);
                auto& inner = *_v.inner;
                return ((std::string("vector[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::HashSet>(_match_68._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_68)>::HashSet>(_match_68._data);
                auto& inner = *_v.inner;
                return ((std::string("set[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::HashMap>(_match_68._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_68)>::HashMap>(_match_68._data);
                auto& k = *_v.key_type;
                auto& v = *_v.value_type;
                return ((((std::string("map[") + ((*this).type_name(k))) + std::string(", ")) + ((*this).type_name(v))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Nullable>(_match_68._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_68)>::Nullable>(_match_68._data);
                auto& inner = *_v.inner;
                return ((std::string("") + ((*this).type_name(inner))) + std::string("?"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Int8>(_match_68._data)) {
                return std::string("int8");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Int16>(_match_68._data)) {
                return std::string("int16");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Int32>(_match_68._data)) {
                return std::string("int32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Float32>(_match_68._data)) {
                return std::string("float32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::USize>(_match_68._data)) {
                return std::string("usize");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::CString>(_match_68._data)) {
                return std::string("cstring");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Ptr>(_match_68._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_68)>::Ptr>(_match_68._data);
                auto& inner = *_v.inner;
    ...
    TypeNode infer_type(const Expr& e) {
        {
            const auto& _match_69 = e;
            if (_match_69._tag == "None") {
                return TypeNode::make_None();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Literal>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Literal>(_match_69._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Variable>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Variable>(_match_69._data);
                auto& name = _v.name;
                auto sym = (*this).lookup(name.lexeme);
                return sym.sym_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Binary>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Binary>(_match_69._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                ...
                {
                    const auto& _match_70 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Str>(_match_70._data)) {
                        return TypeNode::make_Str();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_71 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Float>(_match_71._data)) {
                        return TypeNode::make_Float();
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Unary>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Unary>(_match_69._data);
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Logical>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Logical>(_match_69._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                return TypeNode::make_Bool();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Call>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Call>(_match_69._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).infer_call_type(callee);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Grouping>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Grouping>(_match_69._data);
                auto& inner = *_v.inner;
                return (*this).infer_type(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Index>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Index>(_match_69._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto ot = (*this).infer_type(object);
                {
                    const auto& _match_74 = ot;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Vector>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Vector>(_match_69._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Cast>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Cast>(_match_69._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                return target_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::This>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::This>(_match_69._data);
                auto& kw = _v.keyword;
                return TypeNode::make_Custom(this->current_class_name, {});
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Own>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Own>(_match_69._data);
                auto& expr = *_v.expr;
    ...
    TypeNode infer_call_type(const Expr& callee) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_75)>::StaticGet>(_match_75._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_75)>::StaticGet>(_match_75._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                {
                    const auto& _match_76 = object;
    ...
    void collect_decl(const Stmt& s) {
        {
            const auto& _match_77 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Function>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Function>(_match_77._data);
                auto& name = _v.name;
                auto& params = _v.params;
                auto& return_type = _v.return_type;
                auto& body = _v.body;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Class>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Class>(_match_77._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Enum>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Enum>(_match_77._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Const>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Const>(_match_77._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Struct>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Struct>(_match_77._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Namespace>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Namespace>(_match_77._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Extern>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Extern>(_match_77._data);
                auto& header = _v.header;
                auto& link_lib = _v.link_lib;
                auto& types = _v.types;
                auto& functions = _v.functions;
    ...
    void check_stmt(const Stmt& s) {
        {
            const auto& _match_78 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_78)>::ExprStmt>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::ExprStmt>(_match_78._data);
                auto& expr = _v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Let>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Let>(_match_78._data);
                auto& name = _v.name;
                auto& var_type = _v.var_type;
                auto& initializer = _v.initializer;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Const>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Const>(_match_78._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Return>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Return>(_match_78._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                (*this).check_expr(value);
                {
                    const auto& _match_80 = this->current_return_type;
                    if (_match_80._tag == "None") {
                        /* pass */
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Void>(_match_80._data)) {
                        {
                            const auto& _match_81 = value;
                            if (_match_81._tag == "None") {
                                /* pass */
                            }
                            else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::If>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::If>(_match_78._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::While>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::While>(_match_78._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
                (*this).check_expr(condition);
                (*this).check_stmt(body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::For>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::For>(_match_78._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                auto& is_ref = _v.is_ref;
                ...
                {
                    const auto& _match_82 = coll_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_82)>::Array>(_match_82._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_82)>::Array>(_match_82._data);
                        auto& inner = *_v.inner;
                        item_type = inner;
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Block>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Block>(_match_78._data);
                auto& statements = _v.statements;
                (*this).push_scope();
                for (const auto& st : statements) {
                    (*this).check_stmt(st);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Function>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Function>(_match_78._data);
                auto& name = _v.name;
                auto& params = _v.params;
                auto& return_type = _v.return_type;
                auto& body = _v.body;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Class>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Class>(_match_78._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).check_class(name, body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Struct>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Struct>(_match_78._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                auto& struct_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Enum>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Enum>(_match_78._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& visibility = _v.visibility;
                auto& enum_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Match>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Match>(_match_78._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).check_expr(expr);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Try>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Try>(_match_78._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Namespace>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Namespace>(_match_78._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Import>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Import>(_match_78._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Break>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Break>(_match_78._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Continue>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Continue>(_match_78._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Pass>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Pass>(_match_78._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::CppBlock>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::CppBlock>(_match_78._data);
                auto& code = _v.code;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Extern>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Extern>(_match_78._data);
                auto& header = _v.header;
                auto& link_lib = _v.link_lib;
                auto& types = _v.types;
                auto& functions = _v.functions;
        ...
        for (const auto& s : body) {
            {
                ...
                if (std::holds_alternative<std::decay_t<decltype(_match_83)>::Function>(_match_83._data)) {
    ...
    void check_expr(const Expr& e) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Assign>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::Assign>(_match_84._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(value);
                if ((!(*this).resolve(name.lexeme))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::IndexSet>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::IndexSet>(_match_84._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Map>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::Map>(_match_84._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Get>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::Get>(_match_84._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Set>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::Set>(_match_84._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(object);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::StaticGet>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::StaticGet>(_match_84._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Throw>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::Throw>(_match_84._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Range>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::Range>(_match_84._data);
                auto& start = *_v.start;
                auto& end = *_v.end;
                (*this).check_expr(start);
                (*this).check_expr(end);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Lambda>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::Lambda>(_match_84._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                (*this).push_scope();
                for (const auto& p : params) {
    ...
    void check_call_args(const Expr& callee, const std::vector<Expr>& args, const Token& paren) {
        {
            const auto& _match_85 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Variable>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Variable>(_match_85._data);
                auto& name = _v.name;
                for (int64_t i = 0LL; i < static_cast<int64_t>(this->known_func_names.size()); i++) {
                    if ((this->known_func_names[i] == name.lexeme)) {
...
struct Parser {
    ...
    std::string type_to_string(const TypeNode& t) {
        {
            const auto& _match_86 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Int>(_match_86._data)) {
                return std::string("int64_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Float>(_match_86._data)) {
                return std::string("double");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Str>(_match_86._data)) {
                return std::string("std::string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Bool>(_match_86._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Void>(_match_86._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Auto>(_match_86._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Custom>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Custom>(_match_86._data);
                auto& name = _v.name;
                auto& type_args = _v.type_args;
                if ((static_cast<int64_t>(type_args.size()) > 0LL)) {
                    std::vector<std::string> ta = {};
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Array>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Array>(_match_86._data);
                auto& inner = *_v.inner;
                return ((std::string("std::vector<") + ((*this).type_to_string(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Int8>(_match_86._data)) {
                return std::string("int8_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Int16>(_match_86._data)) {
                return std::string("int16_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Int32>(_match_86._data)) {
                return std::string("int32_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Float32>(_match_86._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::USize>(_match_86._data)) {
                return std::string("size_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::CString>(_match_86._data)) {
                return std::string("const char*");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Ptr>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Ptr>(_match_86._data);
                auto& inner = *_v.inner;
    ...
    Expr assignment() {
        ...
        if ((*this).match_any(std::vector{TK_EQUAL})) {
            ...
            {
                const auto& _match_87 = expr;
                if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Variable>(_match_87._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_87)>::Variable>(_match_87._data);
                    auto& name = _v.name;
                    return Expr::make_Assign(name, value);
                }
                else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Get>(_match_87._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_87)>::Get>(_match_87._data);
                    auto& object = *_v.object;
                    auto& name = _v.name;
                    return Expr::make_Set(object, name, value);
                }
                else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Index>(_match_87._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_87)>::Index>(_match_87._data);
                    auto& object = *_v.object;
                    auto& bracket = _v.bracket;
                    auto& index = *_v.index;
            ...
            if ((*this).match_any(std::vector{TK_PLUS_EQUAL, TK_MINUS_EQUAL, TK_STAR_EQUAL})) {
                ...
                auto op_token = Token(base_type, base_lexeme, compound_op.line, compound_op.col);
                {
                    ...
                    else if (std::holds_alternative<std::decay_t<decltype(_match_88)>::Index>(_match_88._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_88)>::Index>(_match_88._data);
                        auto& object = *_v.object;
                        auto& bracket = _v.bracket;
                        auto& index = *_v.index;
...
void test_parser() {
    ...
    for (const auto& stmt : stmts) {
        {
            const auto& _match_92 = stmt;
            if (std::holds_alternative<std::decay_t<decltype(_match_92)>::ExprStmt>(_match_92._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_92)>::ExprStmt>(_match_92._data);
                auto& expr = _v.expr;
                {
                    const auto& _match_93 = expr;
                    if (std::holds_alternative<std::decay_t<decltype(_match_93)>::Binary>(_match_93._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_93)>::Binary>(_match_93._data);
                        auto& left = *_v.left;
                        auto& op = _v.op;
                        auto& right = *_v.right;
                        print((std::string("Binary: ") + op.lexeme));
                        {
                            const auto& _match_94 = right;
                            if (std::holds_alternative<std::decay_t<decltype(_match_94)>::Binary>(_match_94._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_94)>::Binary>(_match_94._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
