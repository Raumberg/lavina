...
struct Stmt {
    ...
    std::string _tag;
    std::variant<Stmt::None, Stmt::ExprStmt, Stmt::Let, Stmt::Const, Stmt::Return, Stmt::If, Stmt::While, Stmt::For, Stmt::Block, Stmt::Try, Stmt::Function, Stmt::Class, Stmt::Struct, Stmt::Enum, Stmt::Match, Stmt::Namespace, Stmt::Import, Stmt::Break, Stmt::Continue, Stmt::Pass, Stmt::CppBlock> _data;
    ...
    std::string emit_type(const TypeNode& t) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Int>(_match_1._data)) {
                return std::string("int64_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Float>(_match_1._data)) {
                return std::string("double");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Str>(_match_1._data)) {
                return std::string("std::string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Bool>(_match_1._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Void>(_match_1._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Auto>(_match_1._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Dynamic>(_match_1._data)) {
                return std::string("std::any");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::NullType>(_match_1._data)) {
                return std::string("std::nullptr_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Custom>(_match_1._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_1)>::Custom>(_match_1._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Array>(_match_1._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_1)>::Array>(_match_1._data);
                auto& inner = *_v.inner;
                return ((std::string("std::vector<") + ((*this).emit_type(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::HashSet>(_match_1._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_1)>::HashSet>(_match_1._data);
                auto& inner = *_v.inner;
                return ((std::string("std::unordered_set<") + ((*this).emit_type(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::HashMap>(_match_1._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_1)>::HashMap>(_match_1._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Nullable>(_match_1._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_1)>::Nullable>(_match_1._data);
                auto& inner = *_v.inner;
                return ((std::string("std::optional<") + ((*this).emit_type(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Int8>(_match_1._data)) {
                return std::string("int8_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Int16>(_match_1._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Ptr>(_match_1._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_1)>::Ptr>(_match_1._data);
                auto& inner = *_v.inner;
    ...
    std::string emit_expr(const Expr& e, bool m) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Literal>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Literal>(_match_2._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                return (*this).emit_literal(kind, value);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Unary>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Unary>(_match_2._data);
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Binary>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Binary>(_match_2._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Grouping>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Grouping>(_match_2._data);
                auto& inner = *_v.inner;
                return ((std::string("(") + ((*this).emit_expr(inner, m))) + std::string(")"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Variable>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Variable>(_match_2._data);
                auto& name = _v.name;
                return name.lexeme;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Assign>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Assign>(_match_2._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                return ((((std::string("") + (name.lexeme)) + std::string(" = ")) + ((*this).emit_expr(value, m))) + std::string(""));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Logical>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Logical>(_match_2._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                std::string l = (*this).emit_expr(left, m);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Call>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Call>(_match_2._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).emit_call_expr(callee, args, m);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Index>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Index>(_match_2._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::IndexSet>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::IndexSet>(_match_2._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Vector>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Vector>(_match_2._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Map>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Map>(_match_2._data);
                auto& keys = _v.keys;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Get>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Get>(_match_2._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                if (m) {
                    {
                        const auto& _match_3 = object;
                        if (std::holds_alternative<std::decay_t<decltype(_match_3)>::This>(_match_3._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_3)>::This>(_match_3._data);
                            auto& kw = _v.keyword;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Set>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Set>(_match_2._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                if (m) {
                    {
                        ...
                        if (std::holds_alternative<std::decay_t<decltype(_match_4)>::This>(_match_4._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_4)>::This>(_match_4._data);
                            auto& kw = _v.keyword;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::StaticGet>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::StaticGet>(_match_2._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                if (m) {
                    {
                        const auto& _match_5 = object;
                        if (std::holds_alternative<std::decay_t<decltype(_match_5)>::This>(_match_5._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_5)>::This>(_match_5._data);
                            auto& kw = _v.keyword;
                            return ((std::string("(*this)::") + (name.lexeme)) + std::string(""));
                        }
                        else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::This>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::This>(_match_2._data);
                auto& keyword = _v.keyword;
                return std::string("(*this)");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Cast>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Cast>(_match_2._data);
                auto& expr = *_v.expr;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Throw>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Throw>(_match_2._data);
                auto& expr = *_v.expr;
                return ((std::string("throw std::runtime_error(") + ((*this).emit_expr(expr, m))) + std::string(")"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Lambda>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Lambda>(_match_2._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                return (*this).emit_lambda(params, body, m);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Own>(_match_2._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_2)>::Own>(_match_2._data);
                auto& expr = *_v.expr;
    ...
    bool is_dynamic_expression(const Expr& e) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Variable>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::Variable>(_match_6._data);
                auto& name = _v.name;
                return (*this).is_dynamic_var(name.lexeme);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Index>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::Index>(_match_6._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
    ...
    std::string emit_call_expr(const Expr& callee, const std::vector<Expr>& args, bool in_method) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Get>(_match_7._data)) {
                ...
                }
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_8)>::Variable>(_match_8._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_8)>::Variable>(_match_8._data);
                        auto& tok = _v.name;
            ...
            if (track_dynamic) {
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_9)>::Dynamic>(_match_9._data)) {
    ...
    void emit_stmt(const Stmt& s, bool m) {
        {
            ...
            if (_match_10._tag == "None") {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::ExprStmt>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::ExprStmt>(_match_10._data);
                auto& expr = _v.expr;
                this->output = (this->output + ((((std::string("") + ((*this).indent())) + std::string("")) + ((*this).emit_expr(expr, m))) + std::string(";\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Let>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Let>(_match_10._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Const>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Const>(_match_10._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Return>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Return>(_match_10._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::If>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::If>(_match_10._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::While>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::While>(_match_10._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::For>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::For>(_match_10._data);
                ...
                auto& is_mut = _v.is_mut;
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_13)>::Range>(_match_13._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_13)>::Range>(_match_13._data);
                        auto& start = *_v.start;
                        auto& end = *_v.end;
                    ...
                    else {
                        {
                            ...
                            if (std::holds_alternative<std::decay_t<decltype(_match_14)>::Variable>(_match_14._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Block>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Block>(_match_10._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Try>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Try>(_match_10._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Function>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Function>(_match_10._data);
                auto& name = _v.name;
                auto& params = _v.params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Class>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Class>(_match_10._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Struct>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Struct>(_match_10._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                auto& type_params = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Enum>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Enum>(_match_10._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Match>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Match>(_match_10._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).emit_match_impl(expr, arm_patterns, arm_bodies, m);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Namespace>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Namespace>(_match_10._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("// TODO: unsupported namespace\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Import>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Import>(_match_10._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("// TODO: unsupported import\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Break>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Break>(_match_10._data);
                auto& keyword = _v.keyword;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("break;\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Continue>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Continue>(_match_10._data);
                auto& keyword = _v.keyword;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("continue;\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Pass>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Pass>(_match_10._data);
                auto& keyword = _v.keyword;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("/* pass */\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::CppBlock>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::CppBlock>(_match_10._data);
                auto& code = _v.code;
    ...
    void emit_block_or_stmt(const Stmt& s, bool m) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_16)>::Block>(_match_16._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_16)>::Block>(_match_16._data);
        ...
        for (const auto& st : body) {
            {
                ...
                if (std::holds_alternative<std::decay_t<decltype(_match_17)>::Function>(_match_17._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_17)>::Function>(_match_17._data);
                    auto& fname = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& fbody = _v.body;
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_17)>::Let>(_match_17._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_17)>::Let>(_match_17._data);
                    auto& fname = _v.name;
                    auto& var_type = _v.var_type;
            ...
            for (const auto& st : init_body) {
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_18)>::ExprStmt>(_match_18._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_18)>::ExprStmt>(_match_18._data);
                        auto& expr = _v.expr;
                        {
                            const auto& _match_19 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_19)>::Set>(_match_19._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_19)>::Set>(_match_19._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
            ...
            for (const auto& st : init_body) {
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_21)>::ExprStmt>(_match_21._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_21)>::ExprStmt>(_match_21._data);
                        auto& expr = _v.expr;
                        bool handled = false;
                        {
                            const auto& _match_22 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_22)>::Set>(_match_22._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_22)>::Set>(_match_22._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
        ...
        for (const auto& m : methods) {
            {
                ...
                if (std::holds_alternative<std::decay_t<decltype(_match_25)>::Function>(_match_25._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_25)>::Function>(_match_25._data);
                    auto& mname = _v.name;
    ...
    std::string infer_expr_type(const Expr& e, const std::vector<std::string>& param_names, const std::vector<std::string>& param_types) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Literal>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Literal>(_match_26._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                    return std::string("int64_t");
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Variable>(_match_26._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Binary>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Binary>(_match_26._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Unary>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Unary>(_match_26._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                return (*this).infer_expr_type(right, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Grouping>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Grouping>(_match_26._data);
                auto& inner = *_v.inner;
                return (*this).infer_expr_type(inner, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Call>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Call>(_match_26._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Vector>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Vector>(_match_26._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Map>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Map>(_match_26._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Cast>(_match_26._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_26)>::Cast>(_match_26._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
            ...
            for (const auto& ft : v.types) {
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_29)>::Custom>(_match_29._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_29)>::Custom>(_match_29._data);
                        auto& n = _v.name;
                        auto& _ = _v.type_args;
                        if ((n == enum_name)) {
                            has_self_ref = true;
            ...
            if ((static_cast<int64_t>(v.types.size()) > 0LL)) {
                ...
                for (int64_t fi = 0LL; fi < static_cast<int64_t>(v.types.size()); fi++) {
                    ...
                    std::string fname = v.field_names[fi];
                    {
                        ...
                        if (std::holds_alternative<std::decay_t<decltype(_match_30)>::Custom>(_match_30._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_30)>::Custom>(_match_30._data);
                            auto& n = _v.name;
                            auto& _ = _v.type_args;
                            if ((n == enum_name)) {
            ...
            if ((static_cast<int64_t>(v.types.size()) == 0LL)) {
                ...
                for (int64_t fi = 0LL; fi < static_cast<int64_t>(v.types.size()); fi++) {
                    ...
                    bool is_self_ref = false;
                    {
                        ...
                        if (std::holds_alternative<std::decay_t<decltype(_match_31)>::Custom>(_match_31._data)) {
                                ...
                                if ((bi < static_cast<int64_t>(vinfo.types.size()))) {
                                    {
                                        ...
                                        if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Custom>(_match_32._data)) {
                                            auto& _v = std::get<std::decay_t<decltype(_match_32)>::Custom>(_match_32._data);
                                            auto& n = _v.name;
                                            auto& _ = _v.type_args;
                                            if ((n == ename)) {
                                                is_self_ref = true;
    ...
    void emit_arm_body(const Stmt& arm_body, bool in_method) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_33)>::Block>(_match_33._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_33)>::Block>(_match_33._data);
                auto& stmts = _v.statements;
                for (const auto& st : stmts) {
...
struct Checker {
    ...
    bool types_compatible(const TypeNode& expected, const TypeNode& actual) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_35)>::Array>(_match_35._data)) {
                ...
                auto& a_inner = *_v.inner;
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_36)>::Auto>(_match_36._data)) {
                        {
                            const auto& _match_37 = expected;
                            if (std::holds_alternative<std::decay_t<decltype(_match_37)>::Array>(_match_37._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_37)>::Array>(_match_37._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_37)>::HashSet>(_match_37._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_37)>::HashSet>(_match_37._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_37)>::HashMap>(_match_37._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_37)>::HashMap>(_match_37._data);
                                auto& ek = *_v.key_type;
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_38)>::Array>(_match_38._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_38)>::Array>(_match_38._data);
                auto& e_inner = *_v.inner;
                {
                    const auto& _match_39 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_39)>::Array>(_match_39._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_39)>::Array>(_match_39._data);
                        auto& a_inner = *_v.inner;
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Auto>(_match_40._data)) {
                return true;
            }
            else if (_match_40._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Dynamic>(_match_40._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_41)>::Auto>(_match_41._data)) {
                return true;
            }
            else if (_match_41._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_41)>::Dynamic>(_match_41._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        bool a_is_int = false;
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_42)>::Int>(_match_42._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_42)>::Int8>(_match_42._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_42)>::Int16>(_match_42._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_42)>::Int32>(_match_42._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_42)>::USize>(_match_42._data)) {
                e_is_int = true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_43)>::Int>(_match_43._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_43)>::Int8>(_match_43._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_43)>::Int16>(_match_43._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_43)>::Int32>(_match_43._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_43)>::USize>(_match_43._data)) {
                a_is_int = true;
            }
            else {
                /* pass */
        ...
        bool a_is_float = false;
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_44)>::Float>(_match_44._data)) {
                e_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_44)>::Float32>(_match_44._data)) {
                e_is_float = true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_45)>::Float>(_match_45._data)) {
                a_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_45)>::Float32>(_match_45._data)) {
                a_is_float = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_46 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_46)>::CString>(_match_46._data)) {
                {
                    const auto& _match_47 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_47)>::Str>(_match_47._data)) {
                        return true;
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_46)>::Str>(_match_46._data)) {
                {
                    const auto& _match_48 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_48)>::CString>(_match_48._data)) {
                        return true;
                    }
                    else {
                        /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Nullable>(_match_49._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_49)>::Nullable>(_match_49._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_50 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_50)>::NullType>(_match_50._data)) {
                        return true;
                    }
                    else {
    ...
    std::string type_name(const TypeNode& t) {
        {
            const auto& _match_51 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Int>(_match_51._data)) {
                return std::string("int");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Float>(_match_51._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Str>(_match_51._data)) {
                return std::string("string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Bool>(_match_51._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Void>(_match_51._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Auto>(_match_51._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Dynamic>(_match_51._data)) {
                return std::string("dynamic");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::NullType>(_match_51._data)) {
                return std::string("null");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Custom>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::Custom>(_match_51._data);
                auto& name = _v.name;
                auto& _ = _v.type_args;
                return name;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Array>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::Array>(_match_51._data);
                auto& inner = *_v.inner;
                return ((std::string("vector[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::HashSet>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::HashSet>(_match_51._data);
                auto& inner = *_v.inner;
                return ((std::string("set[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::HashMap>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::HashMap>(_match_51._data);
                auto& k = *_v.key_type;
                auto& v = *_v.value_type;
                return ((((std::string("map[") + ((*this).type_name(k))) + std::string(", ")) + ((*this).type_name(v))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Nullable>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::Nullable>(_match_51._data);
                auto& inner = *_v.inner;
                return ((std::string("") + ((*this).type_name(inner))) + std::string("?"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Int8>(_match_51._data)) {
                return std::string("int8");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Int16>(_match_51._data)) {
                return std::string("int16");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Int32>(_match_51._data)) {
                return std::string("int32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Float32>(_match_51._data)) {
                return std::string("float32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::USize>(_match_51._data)) {
                return std::string("usize");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::CString>(_match_51._data)) {
                return std::string("cstring");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Ptr>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::Ptr>(_match_51._data);
                auto& inner = *_v.inner;
    ...
    TypeNode infer_type(const Expr& e) {
        {
            const auto& _match_52 = e;
            if (_match_52._tag == "None") {
                return TypeNode::make_None();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Literal>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Literal>(_match_52._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Variable>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Variable>(_match_52._data);
                auto& name = _v.name;
                auto sym = (*this).lookup(name.lexeme);
                return sym.sym_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Binary>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Binary>(_match_52._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                ...
                {
                    const auto& _match_53 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_53)>::Str>(_match_53._data)) {
                        return TypeNode::make_Str();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_54 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_54)>::Float>(_match_54._data)) {
                        return TypeNode::make_Float();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_55 = rt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Float>(_match_55._data)) {
                        return TypeNode::make_Float();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_56 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Int>(_match_56._data)) {
                        return TypeNode::make_Int();
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Unary>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Unary>(_match_52._data);
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Logical>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Logical>(_match_52._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                return TypeNode::make_Bool();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Call>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Call>(_match_52._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).infer_call_type(callee);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Grouping>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Grouping>(_match_52._data);
                auto& inner = *_v.inner;
                return (*this).infer_type(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Index>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Index>(_match_52._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto ot = (*this).infer_type(object);
                {
                    const auto& _match_57 = ot;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Vector>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Vector>(_match_52._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Cast>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Cast>(_match_52._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                return target_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::This>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::This>(_match_52._data);
                auto& kw = _v.keyword;
                return TypeNode::make_Custom(this->current_class_name, {});
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Own>(_match_52._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_52)>::Own>(_match_52._data);
                auto& expr = *_v.expr;
    ...
    TypeNode infer_call_type(const Expr& callee) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Get>(_match_58._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_58)>::Get>(_match_58._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                return TypeNode::make_Auto();
            }
    ...
    void collect_decl(const Stmt& s) {
        {
            const auto& _match_60 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Function>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Function>(_match_60._data);
                auto& name = _v.name;
                auto& params = _v.params;
                auto& return_type = _v.return_type;
                auto& body = _v.body;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Class>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Class>(_match_60._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Enum>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Enum>(_match_60._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Const>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Const>(_match_60._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Struct>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Struct>(_match_60._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Namespace>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Namespace>(_match_60._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
    ...
    void check_stmt(const Stmt& s) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_61)>::ExprStmt>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::ExprStmt>(_match_61._data);
                auto& expr = _v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Let>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Let>(_match_61._data);
                auto& name = _v.name;
                auto& var_type = _v.var_type;
                auto& initializer = _v.initializer;
                auto& visibility = _v.visibility;
                ...
                {
                    const auto& _match_62 = var_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_62)>::Auto>(_match_62._data)) {
                        /* pass */
                    }
                    else if (_match_62._tag == "None") {
                        /* pass */
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Const>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Const>(_match_61._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Return>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Return>(_match_61._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                (*this).check_expr(value);
                {
                    const auto& _match_63 = this->current_return_type;
                    if (_match_63._tag == "None") {
                        /* pass */
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_63)>::Void>(_match_63._data)) {
                        {
                            const auto& _match_64 = value;
                            if (_match_64._tag == "None") {
                                /* pass */
                            }
                            else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::If>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::If>(_match_61._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::While>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::While>(_match_61._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
                (*this).check_expr(condition);
                (*this).check_stmt(body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::For>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::For>(_match_61._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                auto& is_ref = _v.is_ref;
                ...
                {
                    const auto& _match_65 = coll_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Array>(_match_65._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_65)>::Array>(_match_65._data);
                        auto& inner = *_v.inner;
                        item_type = inner;
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Block>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Block>(_match_61._data);
                auto& statements = _v.statements;
                (*this).push_scope();
                for (const auto& st : statements) {
                    (*this).check_stmt(st);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Function>(_match_61._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Class>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Class>(_match_61._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).check_class(name, body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Struct>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Struct>(_match_61._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                auto& struct_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Enum>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Enum>(_match_61._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& visibility = _v.visibility;
                auto& enum_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Match>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Match>(_match_61._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).check_expr(expr);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Try>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Try>(_match_61._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Namespace>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Namespace>(_match_61._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Import>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Import>(_match_61._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Break>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Break>(_match_61._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Continue>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Continue>(_match_61._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Pass>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Pass>(_match_61._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::CppBlock>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::CppBlock>(_match_61._data);
                auto& code = _v.code;
                /* pass */
            }
            else {
    ...
    void check_expr(const Expr& e) {
        {
            const auto& _match_67 = e;
            if (_match_67._tag == "None") {
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Variable>(_match_67._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Binary>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Binary>(_match_67._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Unary>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Unary>(_match_67._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(right);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Logical>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Logical>(_match_67._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(left);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Grouping>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Grouping>(_match_67._data);
                auto& inner = *_v.inner;
                (*this).check_expr(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Call>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Call>(_match_67._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Assign>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Assign>(_match_67._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(value);
                if ((!(*this).resolve(name.lexeme))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Index>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Index>(_match_67._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::IndexSet>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::IndexSet>(_match_67._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Vector>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Vector>(_match_67._data);
                auto& elements = _v.elements;
                for (const auto& el : elements) {
                    (*this).check_expr(el);
                }
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Map>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Map>(_match_67._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Set>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Set>(_match_67._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(object);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Cast>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Cast>(_match_67._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Throw>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Throw>(_match_67._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Range>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Range>(_match_67._data);
                auto& start = *_v.start;
                auto& end = *_v.end;
                (*this).check_expr(start);
                (*this).check_expr(end);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Lambda>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Lambda>(_match_67._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                (*this).push_scope();
                for (const auto& p : params) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Own>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Own>(_match_67._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else {
...
struct Parser {
    ...
    std::string type_to_string(const TypeNode& t) {
        {
            const auto& _match_69 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Int>(_match_69._data)) {
                return std::string("int64_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Float>(_match_69._data)) {
                return std::string("double");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Str>(_match_69._data)) {
                return std::string("std::string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Bool>(_match_69._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Void>(_match_69._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Auto>(_match_69._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Custom>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Custom>(_match_69._data);
                auto& name = _v.name;
                auto& type_args = _v.type_args;
                if ((static_cast<int64_t>(type_args.size()) > 0LL)) {
                    std::vector<std::string> ta = {};
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Array>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Array>(_match_69._data);
                auto& inner = *_v.inner;
                return ((std::string("std::vector<") + ((*this).type_to_string(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Int8>(_match_69._data)) {
                return std::string("int8_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Int16>(_match_69._data)) {
                return std::string("int16_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Int32>(_match_69._data)) {
                return std::string("int32_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Float32>(_match_69._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::USize>(_match_69._data)) {
                return std::string("size_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::CString>(_match_69._data)) {
                return std::string("const char*");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Ptr>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Ptr>(_match_69._data);
                auto& inner = *_v.inner;
    ...
    Expr assignment() {
        ...
        if ((*this).match_any(std::vector{TK_EQUAL})) {
            ...
            {
                const auto& _match_70 = expr;
                if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Variable>(_match_70._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_70)>::Variable>(_match_70._data);
                    auto& name = _v.name;
                    return Expr::make_Assign(name, value);
                }
                else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Get>(_match_70._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_70)>::Get>(_match_70._data);
                    auto& object = *_v.object;
                    auto& name = _v.name;
                    return Expr::make_Set(object, name, value);
                }
                else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Index>(_match_70._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_70)>::Index>(_match_70._data);
                    auto& object = *_v.object;
                    auto& bracket = _v.bracket;
                    auto& index = *_v.index;
            ...
            if ((*this).match_any(std::vector{TK_PLUS_EQUAL, TK_MINUS_EQUAL, TK_STAR_EQUAL})) {
                ...
                {
                    const auto& _match_71 = expr;
                    if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Variable>(_match_71._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_71)>::Variable>(_match_71._data);
                        auto& name = _v.name;
                        Expr bin = Expr::make_Binary(Expr::make_Variable(name), op_token, rhs);
                        return Expr::make_Assign(name, bin);
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Get>(_match_71._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_71)>::Get>(_match_71._data);
                        auto& object = *_v.object;
                        auto& name = _v.name;
                        Expr bin = Expr::make_Binary(Expr::make_Get(object, name), op_token, rhs);
                        return Expr::make_Set(object, name, bin);
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Index>(_match_71._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_71)>::Index>(_match_71._data);
                        auto& object = *_v.object;
                        auto& bracket = _v.bracket;
                        auto& index = *_v.index;
    ...
    Expr call() {
        ...
        {
            const auto& _match_72 = expr;
            if (std::holds_alternative<std::decay_t<decltype(_match_72)>::Variable>(_match_72._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_72)>::Variable>(_match_72._data);
                auto& tok = _v.name;
                if ((*this).check(TK_LEFT_BRACKET)) {
                    int64_t save_pos = this->current;
                    (*this).advance();
    ...
    Expr finish_call(const Expr& callee) {
        {
            const auto& _match_73 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_73)>::Variable>(_match_73._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_73)>::Variable>(_match_73._data);
                auto& name = _v.name;
            ...
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).check(TK_IDENTIFIER) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                    ...
                    if ((*this).check(TK_IDENTIFIER) && (((*this).peek_at(1LL).token_type == TK_NEWLINE) || ((*this).peek_at(1LL).token_type == TK_DEDENT))) {
                        ...
                        {
                            const auto& _match_74 = vtype;
                            if (std::holds_alternative<std::decay_t<decltype(_match_74)>::NullType>(_match_74._data)) {
                                is_unit_type = true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_74)>::Void>(_match_74._data)) {
                                is_unit_type = true;
                            }
                            else {
                                /* pass */
    ...
    for (const auto& stmt : stmts) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_75)>::ExprStmt>(_match_75._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_75)>::ExprStmt>(_match_75._data);
                auto& expr = _v.expr;
                {
                    const auto& _match_76 = expr;
                    if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Binary>(_match_76._data)) {
                        ...
                        {
                            const auto& _match_77 = right;
                            if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Binary>(_match_77._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Binary>(_match_77._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
