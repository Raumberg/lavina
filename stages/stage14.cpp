// Stage 14: extern blocks for FFI
#include "lavina.h"
...
struct CppCodegen {
    ...
    void emit_stmt(const Stmt& s, bool m) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_10)>::Extern>(_match_10._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_10)>::Extern>(_match_10._data);
    ...
    void emit_let(const Token& name, const TypeNode& var_type, const Expr& initializer, bool in_method, bool is_ref, bool is_mut) {
        ...
        std::string init_str = std::string("");
        {
            ...
            if (_match_15._tag == "None") {
                ...
                bool is_ptr = false;
                {
                    const auto& _match_16 = var_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_16)>::Ptr>(_match_16._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_16)>::Ptr>(_match_16._data);
                        auto& inner = *_v.inner;
                        is_ptr = true;
                    }
                    else {
    ...
    void emit_block_or_stmt(const Stmt& s, bool m) {
        {
            const auto& _match_17 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_17)>::Block>(_match_17._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_17)>::Block>(_match_17._data);
    ...
    void emit_class(const Token& name, const std::vector<Stmt>& body, const std::vector<std::string>& type_params) {
        ...
        for (const auto& st : body) {
            {
                ...
                if (std::holds_alternative<std::decay_t<decltype(_match_18)>::Function>(_match_18._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_18)>::Function>(_match_18._data);
                    auto& fname = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& fbody = _v.body;
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_18)>::Let>(_match_18._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_18)>::Let>(_match_18._data);
                    auto& fname = _v.name;
                    auto& var_type = _v.var_type;
        ...
        if (has_init) {
            ...
            for (const auto& st : init_body) {
                {
                    const auto& _match_19 = st;
                    if (std::holds_alternative<std::decay_t<decltype(_match_19)>::ExprStmt>(_match_19._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_19)>::ExprStmt>(_match_19._data);
                        auto& expr = _v.expr;
                        {
                            const auto& _match_20 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_20)>::Set>(_match_20._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_20)>::Set>(_match_20._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    const auto& _match_21 = object;
                                    if (std::holds_alternative<std::decay_t<decltype(_match_21)>::This>(_match_21._data)) {
                                        auto& _v = std::get<std::decay_t<decltype(_match_21)>::This>(_match_21._data);
                                        auto& kw = _v.keyword;
                                        bool already = false;
        ...
        if (has_init) {
            ...
            for (const auto& st : init_body) {
                {
                    const auto& _match_22 = st;
                    if (std::holds_alternative<std::decay_t<decltype(_match_22)>::ExprStmt>(_match_22._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_22)>::ExprStmt>(_match_22._data);
                        auto& expr = _v.expr;
                        bool handled = false;
                        {
                            const auto& _match_23 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_23)>::Set>(_match_23._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_23)>::Set>(_match_23._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    ...
                                    if (std::holds_alternative<std::decay_t<decltype(_match_24)>::This>(_match_24._data)) {
                                        ...
                                        auto& kw = _v.keyword;
                                        {
                                            const auto& _match_25 = value;
                                            if (std::holds_alternative<std::decay_t<decltype(_match_25)>::Variable>(_match_25._data)) {
        ...
        for (const auto& m : methods) {
            {
                const auto& _match_26 = m;
                if (std::holds_alternative<std::decay_t<decltype(_match_26)>::Function>(_match_26._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_26)>::Function>(_match_26._data);
                    auto& mname = _v.name;
    ...
    std::string infer_expr_type(const Expr& e, const std::vector<std::string>& param_names, const std::vector<std::string>& param_types) {
        {
            const auto& _match_27 = e;
            if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Literal>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Literal>(_match_27._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                    return std::string("int64_t");
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Binary>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Binary>(_match_27._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Unary>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Unary>(_match_27._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                return (*this).infer_expr_type(right, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Grouping>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Grouping>(_match_27._data);
                auto& inner = *_v.inner;
                return (*this).infer_expr_type(inner, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Call>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Call>(_match_27._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                {
                    const auto& _match_28 = callee;
                    ...
                    else if (std::holds_alternative<std::decay_t<decltype(_match_28)>::StaticGet>(_match_28._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_28)>::StaticGet>(_match_28._data);
                        auto& object = *_v.object;
                        auto& name = _v.name;
                        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Vector>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Vector>(_match_27._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Map>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Map>(_match_27._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_27)>::Cast>(_match_27._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_27)>::Cast>(_match_27._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
        ...
        for (const auto& v : variants) {
            ...
            if ((static_cast<int64_t>(v.types.size()) == 0LL)) {
                ...
                for (int64_t fi = 0LL; fi < static_cast<int64_t>(v.types.size()); fi++) {
                    ...
                    {
                        const auto& _match_32 = v.types[fi];
                        ...
                        for (int64_t bi = 0LL; bi < static_cast<int64_t>(arm.bindings.size()); bi++) {
                            if ((bi < static_cast<int64_t>(vinfo.field_names.size()))) {
                                ...
                                if ((bi < static_cast<int64_t>(vinfo.types.size()))) {
                                    {
                                        const auto& _match_33 = vinfo.types[bi];
                                        if (std::holds_alternative<std::decay_t<decltype(_match_33)>::Custom>(_match_33._data)) {
    ...
    void emit_arm_body(const Stmt& arm_body, bool in_method) {
        {
            const auto& _match_34 = arm_body;
            if (std::holds_alternative<std::decay_t<decltype(_match_34)>::Block>(_match_34._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_34)>::Block>(_match_34._data);
                auto& stmts = _v.statements;
                for (const auto& st : stmts) {
    ...
    std::string generate(const std::vector<Stmt>& stmts) {
        for (const auto& stmt : stmts) {
            {
                const auto& _match_35 = stmt;
                if (std::holds_alternative<std::decay_t<decltype(_match_35)>::Extern>(_match_35._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_35)>::Extern>(_match_35._data);
                    auto& header = _v.header;
                    auto& link_lib = _v.link_lib;
                    auto& types = _v.types;
                    auto& functions = _v.functions;
        ...
        for (const auto& stmt : stmts) {
            {
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_36)>::Extern>(_match_36._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_36)>::Extern>(_match_36._data);
                    auto& header = _v.header;
                    auto& link_lib = _v.link_lib;
                    auto& types = _v.types;
                    auto& functions = _v.functions;
...
struct Checker {
    ...
    bool types_compatible(const TypeNode& expected, const TypeNode& actual) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_37)>::Array>(_match_37._data)) {
                ...
                {
                    const auto& _match_38 = a_inner;
                    if (std::holds_alternative<std::decay_t<decltype(_match_38)>::Auto>(_match_38._data)) {
                        {
                            const auto& _match_39 = expected;
                            ...
                            else if (std::holds_alternative<std::decay_t<decltype(_match_39)>::HashSet>(_match_39._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_39)>::HashSet>(_match_39._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_39)>::HashMap>(_match_39._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_39)>::HashMap>(_match_39._data);
                                auto& ek = *_v.key_type;
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Array>(_match_40._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_40)>::Array>(_match_40._data);
                auto& e_inner = *_v.inner;
                {
                    const auto& _match_41 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_41)>::Array>(_match_41._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_41)>::Array>(_match_41._data);
                        auto& a_inner = *_v.inner;
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_42)>::Auto>(_match_42._data)) {
                return true;
            }
            else if (_match_42._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_42)>::Dynamic>(_match_42._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            else if (_match_43._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_43)>::Dynamic>(_match_43._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        bool a_is_int = false;
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_44)>::Int>(_match_44._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_44)>::Int8>(_match_44._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_44)>::Int16>(_match_44._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_44)>::Int32>(_match_44._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_44)>::USize>(_match_44._data)) {
                e_is_int = true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_45)>::Int>(_match_45._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_45)>::Int8>(_match_45._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_45)>::Int16>(_match_45._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_45)>::Int32>(_match_45._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_45)>::USize>(_match_45._data)) {
                a_is_int = true;
            }
            else {
                /* pass */
        ...
        bool a_is_float = false;
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_46)>::Float>(_match_46._data)) {
                e_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_46)>::Float32>(_match_46._data)) {
                e_is_float = true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_47)>::Float>(_match_47._data)) {
                a_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_47)>::Float32>(_match_47._data)) {
                a_is_float = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_48 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_48)>::CString>(_match_48._data)) {
                {
                    const auto& _match_49 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Str>(_match_49._data)) {
                        return true;
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_48)>::Str>(_match_48._data)) {
                {
                    const auto& _match_50 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_50)>::CString>(_match_50._data)) {
                        return true;
                    }
                    else {
                        /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Nullable>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::Nullable>(_match_51._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_52 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_52)>::NullType>(_match_52._data)) {
                        return true;
                    }
                    else {
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_53)>::Ptr>(_match_53._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_53)>::Ptr>(_match_53._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_54 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_54)>::NullType>(_match_54._data)) {
                        return true;
                    }
                    else {
                        /* pass */
    ...
    std::string type_name(const TypeNode& t) {
        {
            const auto& _match_55 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Int>(_match_55._data)) {
                return std::string("int");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Float>(_match_55._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Str>(_match_55._data)) {
                return std::string("string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Bool>(_match_55._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Void>(_match_55._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Auto>(_match_55._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Dynamic>(_match_55._data)) {
                return std::string("dynamic");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::NullType>(_match_55._data)) {
                return std::string("null");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Custom>(_match_55._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_55)>::Custom>(_match_55._data);
                auto& name = _v.name;
                auto& _ = _v.type_args;
                return name;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Array>(_match_55._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::HashSet>(_match_55._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_55)>::HashSet>(_match_55._data);
                auto& inner = *_v.inner;
                return ((std::string("set[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::HashMap>(_match_55._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_55)>::HashMap>(_match_55._data);
                auto& k = *_v.key_type;
                auto& v = *_v.value_type;
                return ((((std::string("map[") + ((*this).type_name(k))) + std::string(", ")) + ((*this).type_name(v))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Nullable>(_match_55._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_55)>::Nullable>(_match_55._data);
                auto& inner = *_v.inner;
                return ((std::string("") + ((*this).type_name(inner))) + std::string("?"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Int8>(_match_55._data)) {
                return std::string("int8");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Int16>(_match_55._data)) {
                return std::string("int16");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Int32>(_match_55._data)) {
                return std::string("int32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Float32>(_match_55._data)) {
                return std::string("float32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::USize>(_match_55._data)) {
                return std::string("usize");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::CString>(_match_55._data)) {
                return std::string("cstring");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_55)>::Ptr>(_match_55._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_55)>::Ptr>(_match_55._data);
                auto& inner = *_v.inner;
    ...
    TypeNode infer_type(const Expr& e) {
        {
            const auto& _match_56 = e;
            if (_match_56._tag == "None") {
                return TypeNode::make_None();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Literal>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Literal>(_match_56._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Variable>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Variable>(_match_56._data);
                auto& name = _v.name;
                auto sym = (*this).lookup(name.lexeme);
                return sym.sym_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Binary>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Binary>(_match_56._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                ...
                {
                    const auto& _match_57 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_57)>::Str>(_match_57._data)) {
                        return TypeNode::make_Str();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_58 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Float>(_match_58._data)) {
                        return TypeNode::make_Float();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_59 = rt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_59)>::Float>(_match_59._data)) {
                        return TypeNode::make_Float();
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Unary>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Unary>(_match_56._data);
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Logical>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Logical>(_match_56._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                return TypeNode::make_Bool();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Call>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Call>(_match_56._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).infer_call_type(callee);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Grouping>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Grouping>(_match_56._data);
                auto& inner = *_v.inner;
                return (*this).infer_type(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Index>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Index>(_match_56._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto ot = (*this).infer_type(object);
                {
                    const auto& _match_61 = ot;
                    if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Array>(_match_61._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_61)>::Array>(_match_61._data);
                        auto& inner = *_v.inner;
                        return inner;
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Vector>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Vector>(_match_56._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Cast>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Cast>(_match_56._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                return target_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::This>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::This>(_match_56._data);
                auto& kw = _v.keyword;
                return TypeNode::make_Custom(this->current_class_name, {});
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Own>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Own>(_match_56._data);
                auto& expr = *_v.expr;
    ...
    TypeNode infer_call_type(const Expr& callee) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_62)>::Get>(_match_62._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_62)>::Get>(_match_62._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                return TypeNode::make_Auto();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_62)>::StaticGet>(_match_62._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_62)>::StaticGet>(_match_62._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                {
                    const auto& _match_63 = object;
                    if (std::holds_alternative<std::decay_t<decltype(_match_63)>::Variable>(_match_63._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_63)>::Variable>(_match_63._data);
    ...
    void collect_decl(const Stmt& s) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_64)>::Namespace>(_match_64._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_64)>::Namespace>(_match_64._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_64)>::Extern>(_match_64._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_64)>::Extern>(_match_64._data);
                auto& header = _v.header;
                auto& link_lib = _v.link_lib;
                auto& types = _v.types;
                auto& functions = _v.functions;
    ...
    void check_stmt(const Stmt& s) {
        {
            const auto& _match_65 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_65)>::ExprStmt>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::ExprStmt>(_match_65._data);
                auto& expr = _v.expr;
                ...
                {
                    const auto& _match_66 = var_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_66)>::Auto>(_match_66._data)) {
                        /* pass */
                    }
                    else if (_match_66._tag == "None") {
                        /* pass */
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Return>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Return>(_match_65._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                (*this).check_expr(value);
                {
                    const auto& _match_67 = this->current_return_type;
                    if (_match_67._tag == "None") {
                        /* pass */
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Void>(_match_67._data)) {
                        {
                            const auto& _match_68 = value;
                            if (_match_68._tag == "None") {
                                /* pass */
                            }
                            else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::If>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::If>(_match_65._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::While>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::While>(_match_65._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
                (*this).check_expr(condition);
                (*this).check_stmt(body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::For>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::For>(_match_65._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                auto& is_ref = _v.is_ref;
                ...
                {
                    const auto& _match_69 = coll_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Array>(_match_69._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Block>(_match_65._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Function>(_match_65._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Match>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Match>(_match_65._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).check_expr(expr);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Try>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Try>(_match_65._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Namespace>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Namespace>(_match_65._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Import>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Import>(_match_65._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Break>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Break>(_match_65._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Continue>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Continue>(_match_65._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Pass>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Pass>(_match_65._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_65)>::CppBlock>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::CppBlock>(_match_65._data);
                auto& code = _v.code;
                /* pass */
            }
    ...
    void check_expr(const Expr& e) {
        {
            const auto& _match_71 = e;
            if (_match_71._tag == "None") {
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Variable>(_match_71._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Binary>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Binary>(_match_71._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Unary>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Unary>(_match_71._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(right);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Logical>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Logical>(_match_71._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(left);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Grouping>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Grouping>(_match_71._data);
                auto& inner = *_v.inner;
                (*this).check_expr(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Call>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Call>(_match_71._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Assign>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Assign>(_match_71._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(value);
                if ((!(*this).resolve(name.lexeme))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::IndexSet>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::IndexSet>(_match_71._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Vector>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Vector>(_match_71._data);
                auto& elements = _v.elements;
                for (const auto& el : elements) {
                    (*this).check_expr(el);
                }
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Map>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Map>(_match_71._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Set>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Set>(_match_71._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(object);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::StaticGet>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::StaticGet>(_match_71._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Cast>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Cast>(_match_71._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Throw>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Throw>(_match_71._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Range>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Range>(_match_71._data);
                auto& start = *_v.start;
                auto& end = *_v.end;
                (*this).check_expr(start);
                (*this).check_expr(end);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Lambda>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Lambda>(_match_71._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                (*this).push_scope();
                for (const auto& p : params) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Own>(_match_71._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_71)>::Own>(_match_71._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else {
...
struct Parser {
    ...
    Expr assignment() {
        ...
        if ((*this).match_any(std::vector{TK_EQUAL})) {
            ...
            {
                const auto& _match_74 = expr;
                if (std::holds_alternative<std::decay_t<decltype(_match_74)>::Variable>(_match_74._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_74)>::Variable>(_match_74._data);
                    auto& name = _v.name;
                    return Expr::make_Assign(name, value);
                }
                else if (std::holds_alternative<std::decay_t<decltype(_match_74)>::Get>(_match_74._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_74)>::Get>(_match_74._data);
                    auto& object = *_v.object;
                    auto& name = _v.name;
            ...
            if ((*this).match_any(std::vector{TK_PLUS_EQUAL, TK_MINUS_EQUAL, TK_STAR_EQUAL})) {
                ...
                {
                    const auto& _match_75 = expr;
                    if (std::holds_alternative<std::decay_t<decltype(_match_75)>::Variable>(_match_75._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_75)>::Variable>(_match_75._data);
                        auto& name = _v.name;
                        Expr bin = Expr::make_Binary(Expr::make_Variable(name), op_token, rhs);
                        return Expr::make_Assign(name, bin);
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_75)>::Get>(_match_75._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_75)>::Get>(_match_75._data);
                        auto& object = *_v.object;
                        auto& name = _v.name;
                        Expr bin = Expr::make_Binary(Expr::make_Get(object, name), op_token, rhs);
                        return Expr::make_Set(object, name, bin);
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_75)>::Index>(_match_75._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_75)>::Index>(_match_75._data);
                        auto& object = *_v.object;
                        auto& bracket = _v.bracket;
                        auto& index = *_v.index;
    ...
    Expr call() {
        Expr expr = (*this).primary();
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Variable>(_match_76._data)) {
            ...
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).check(TK_IDENTIFIER) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                    ...
                    if ((*this).check(TK_IDENTIFIER) && (((*this).peek_at(1LL).token_type == TK_NEWLINE) || ((*this).peek_at(1LL).token_type == TK_DEDENT))) {
                        ...
                        {
                            const auto& _match_78 = vtype;
                            if (std::holds_alternative<std::decay_t<decltype(_match_78)>::NullType>(_match_78._data)) {
                                is_unit_type = true;
                            }
...
void test_parser() {
    ...
    for (const auto& stmt : stmts) {
        {
            const auto& _match_79 = stmt;
            if (std::holds_alternative<std::decay_t<decltype(_match_79)>::ExprStmt>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::ExprStmt>(_match_79._data);
                auto& expr = _v.expr;
                {
                    const auto& _match_80 = expr;
                    if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Binary>(_match_80._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_80)>::Binary>(_match_80._data);
                        auto& left = *_v.left;
                        auto& op = _v.op;
                        auto& right = *_v.right;
                        print((std::string("Binary: ") + op.lexeme));
                        {
                            const auto& _match_81 = right;
                            if (std::holds_alternative<std::decay_t<decltype(_match_81)>::Binary>(_match_81._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_81)>::Binary>(_match_81._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
