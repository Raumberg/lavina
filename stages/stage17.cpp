...
struct Expr {
    ...
    std::string _tag;
    std::variant<Expr::None, Expr::Literal, Expr::Unary, Expr::Binary, Expr::Grouping, Expr::Variable, Expr::Assign, Expr::Logical, Expr::Call, Expr::Index, Expr::IndexSet, Expr::Vector, Expr::Map, Expr::Get, Expr::Set, Expr::StaticGet, Expr::This, Expr::Cast, Expr::Throw, Expr::Range, Expr::Lambda> _data;
...
struct Stmt {
    ...
    std::string _tag;
    std::variant<Stmt::None, Stmt::ExprStmt, Stmt::Let, Stmt::Const, Stmt::Return, Stmt::If, Stmt::While, Stmt::For, Stmt::Block, Stmt::Try, Stmt::Function, Stmt::Class, Stmt::Struct, Stmt::Enum, Stmt::Match, Stmt::Namespace, Stmt::Import, Stmt::Break, Stmt::Continue> _data;
...
struct CppCodegen {
    ...
    std::string emit_expr(Expr e) {
        {
            ...
            if (_match_2._tag == "None") {
                ...
                auto& inner = *_v.inner;
                return ((std::string("(") + ((*this).emit_expr(inner))) + std::string(")"));
            }
                ...
                auto& name = _v.name;
                auto& value = *_v.value;
                return ((((std::string("") + (name.lexeme)) + std::string(" = ")) + ((*this).emit_expr(value))) + std::string(""));
            }
                ...
                auto& index = *_v.index;
                return ((((std::string("") + ((*this).emit_expr(object))) + std::string("[")) + ((*this).emit_expr(index))) + std::string("]"));
            }
                ...
                auto& index = *_v.index;
                auto& value = *_v.value;
                return ((((((std::string("") + ((*this).emit_expr(object))) + std::string("[")) + ((*this).emit_expr(index))) + std::string("] = ")) + ((*this).emit_expr(value))) + std::string(""));
            }
                ...
                for (int64_t i = 0LL; i < static_cast<int64_t>(keys.size()); i++) {
                    entries.push_back(((((std::string("{") + ((*this).emit_expr(keys[i]))) + std::string(", ")) + ((*this).emit_expr(values[i]))) + std::string("}")));
                }
                ...
                auto& object = *_v.object;
                auto& name = _v.name;
                return ((((std::string("") + ((*this).emit_expr(object))) + std::string(".")) + (name.lexeme)) + std::string(""));
            }
                ...
                auto& name = _v.name;
                auto& value = *_v.value;
                return ((((((std::string("") + ((*this).emit_expr(object))) + std::string(".")) + (name.lexeme)) + std::string(" = ")) + ((*this).emit_expr(value))) + std::string(""));
            }
    ...
    bool is_dynamic_expression(Expr e) {
        {
            auto& _match_3 = e;
            if (std::holds_alternative<Expr::Variable>(_match_3._data)) {
                auto& _v = std::get<Expr::Variable>(_match_3._data);
                auto& name = _v.name;
                return (*this).is_dynamic_var(name.lexeme);
            }
            else if (std::holds_alternative<Expr::Index>(_match_3._data)) {
                auto& _v = std::get<Expr::Index>(_match_3._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
    ...
    std::string emit_call_expr(Expr callee, std::vector<Expr> args, bool in_method) {
        {
            auto& _match_4 = callee;
            if (std::holds_alternative<Expr::Get>(_match_4._data)) {
                auto& _v = std::get<Expr::Get>(_match_4._data);
                auto& object = *_v.object;
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<Expr::StaticGet>(_match_4._data)) {
                auto& _v = std::get<Expr::StaticGet>(_match_4._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                std::string obj = std::string("");
                if (in_method) {
                ...
                {
                    auto& _match_5 = object;
                    if (std::holds_alternative<Expr::Variable>(_match_5._data)) {
                        auto& _v = std::get<Expr::Variable>(_match_5._data);
                        auto& tok = _v.name;
            ...
            else if (std::holds_alternative<Expr::Variable>(_match_4._data)) {
                auto& _v = std::get<Expr::Variable>(_match_4._data);
                auto& tok = _v.name;
                std::vector<std::string> arg_strs = {};
                for (auto& a : args) {
                    if (in_method) {
    ...
    std::string emit_method_expr(Expr e) {
        {
            auto& _match_6 = e;
            if (std::holds_alternative<Expr::Set>(_match_6._data)) {
                auto& _v = std::get<Expr::Set>(_match_6._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                {
                    auto& _match_7 = object;
                    if (std::holds_alternative<Expr::This>(_match_7._data)) {
                        auto& _v = std::get<Expr::This>(_match_7._data);
                        auto& kw = _v.keyword;
                        return ((((std::string("this->") + (name.lexeme)) + std::string(" = ")) + ((*this).emit_method_expr(value))) + std::string(""));
                    }
                    else {
                        return ((((((std::string("") + ((*this).emit_method_expr(object))) + std::string(".")) + (name.lexeme)) + std::string(" = ")) + ((*this).emit_method_expr(value))) + std::string(""));
                    }
                }
            }
            else if (std::holds_alternative<Expr::Get>(_match_6._data)) {
                auto& _v = std::get<Expr::Get>(_match_6._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                {
                    auto& _match_8 = object;
                    if (std::holds_alternative<Expr::This>(_match_8._data)) {
                        auto& _v = std::get<Expr::This>(_match_8._data);
                        auto& kw = _v.keyword;
                        return ((std::string("this->") + (name.lexeme)) + std::string(""));
                    }
                    else {
                        return ((((std::string("") + ((*this).emit_method_expr(object))) + std::string(".")) + (name.lexeme)) + std::string(""));
                    }
                }
            }
            else if (std::holds_alternative<Expr::This>(_match_6._data)) {
                auto& _v = std::get<Expr::This>(_match_6._data);
                auto& keyword = _v.keyword;
                return std::string("(*this)");
            }
            else if (std::holds_alternative<Expr::Grouping>(_match_6._data)) {
                auto& _v = std::get<Expr::Grouping>(_match_6._data);
                auto& inner = *_v.inner;
                return ((std::string("(") + ((*this).emit_method_expr(inner))) + std::string(")"));
            }
                ...
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                return ((((std::string("") + ((*this).emit_method_expr(object))) + std::string("[")) + ((*this).emit_method_expr(index))) + std::string("]"));
            }
            else if (std::holds_alternative<Expr::IndexSet>(_match_6._data)) {
                auto& _v = std::get<Expr::IndexSet>(_match_6._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
                return ((((((std::string("") + ((*this).emit_method_expr(object))) + std::string("[")) + ((*this).emit_method_expr(index))) + std::string("] = ")) + ((*this).emit_method_expr(value))) + std::string(""));
            }
            else if (std::holds_alternative<Expr::Vector>(_match_6._data)) {
                auto& _v = std::get<Expr::Vector>(_match_6._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) == 0LL)) {
                    return std::string("{}");
                }
            ...
            else if (std::holds_alternative<Expr::Binary>(_match_6._data)) {
                auto& _v = std::get<Expr::Binary>(_match_6._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<Expr::Unary>(_match_6._data)) {
                auto& _v = std::get<Expr::Unary>(_match_6._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                std::string r = (*this).emit_method_expr(right);
                std::string op_str = (*this).token_to_cpp_op(op);
            ...
            else if (std::holds_alternative<Expr::Logical>(_match_6._data)) {
                auto& _v = std::get<Expr::Logical>(_match_6._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                std::string l = (*this).emit_method_expr(left);
            ...
            else if (std::holds_alternative<Expr::Assign>(_match_6._data)) {
                auto& _v = std::get<Expr::Assign>(_match_6._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                return ((((std::string("") + (name.lexeme)) + std::string(" = ")) + ((*this).emit_method_expr(value))) + std::string(""));
            }
            else if (std::holds_alternative<Expr::Call>(_match_6._data)) {
                auto& _v = std::get<Expr::Call>(_match_6._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).emit_call_expr(callee, args, true);
            }
            else if (std::holds_alternative<Expr::Map>(_match_6._data)) {
                auto& _v = std::get<Expr::Map>(_match_6._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
                std::vector<std::string> entries = {};
                for (int64_t i = 0LL; i < static_cast<int64_t>(keys.size()); i++) {
                    entries.push_back(((((std::string("{") + ((*this).emit_method_expr(keys[i]))) + std::string(", ")) + ((*this).emit_method_expr(values[i]))) + std::string("}")));
                }
                return ((std::string("{{") + (lv_join(entries, std::string(", ")))) + std::string("}}"));
            }
            else if (std::holds_alternative<Expr::StaticGet>(_match_6._data)) {
                auto& _v = std::get<Expr::StaticGet>(_match_6._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                {
                    auto& _match_9 = object;
                    if (std::holds_alternative<Expr::This>(_match_9._data)) {
                        auto& _v = std::get<Expr::This>(_match_9._data);
                        auto& kw = _v.keyword;
                        return ((std::string("(*this)::") + (name.lexeme)) + std::string(""));
                    }
                    else {
            ...
            else if (std::holds_alternative<Expr::Cast>(_match_6._data)) {
                auto& _v = std::get<Expr::Cast>(_match_6._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                std::string ex = (*this).emit_method_expr(expr);
                std::string t = (*this).emit_type(target_type);
                if ((*this).is_dynamic_expression(expr)) {
                    return ((((std::string("std::any_cast<") + (t)) + std::string(">(")) + (ex)) + std::string(")"));
                }
            ...
            else if (std::holds_alternative<Expr::Throw>(_match_6._data)) {
                auto& _v = std::get<Expr::Throw>(_match_6._data);
                auto& expr = *_v.expr;
                return ((std::string("throw std::runtime_error(") + ((*this).emit_method_expr(expr))) + std::string(")"));
            }
            else if (std::holds_alternative<Expr::Literal>(_match_6._data)) {
                auto& _v = std::get<Expr::Literal>(_match_6._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                return (*this).emit_literal(kind, value);
            }
            else if (std::holds_alternative<Expr::Lambda>(_match_6._data)) {
                auto& _v = std::get<Expr::Lambda>(_match_6._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                return (*this).emit_lambda(params, body, true);
            }
            else {
    ...
    std::string emit_lambda(std::vector<Param> params, Expr body, bool in_method) {
        ...
        for (auto& p : params) {
            param_strs.push_back(((((std::string("") + ((*this).emit_type(p.param_type))) + std::string(" ")) + (p.name.lexeme)) + std::string("")));
        }
        std::string body_str = std::string("");
        if (in_method) {
            body_str = (*this).emit_method_expr(body);
        }
         else {
            body_str = (*this).emit_expr(body);
        }
        return ((((std::string("[&](") + (lv_join(param_strs, std::string(", ")))) + std::string(") { return ")) + (body_str)) + std::string("; }"));
    }
    ...
    void emit_stmt(Stmt s) {
        {
            ...
            if (_match_10._tag == "None") {
                ...
                auto& expr = _v.expr;
                this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + ((*this).emit_expr(expr))) + std::string(";\n"));
            }
                ...
                auto& value = _v.value;
                {
                    auto& _match_11 = value;
                    if (_match_11._tag == "None") {
                        this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("return;\n"));
                    }
                    else {
                        this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("return ")) + ((*this).emit_expr(value))) + std::string(";\n"));
                    }
                }
            }
                ...
                this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("if (")) + ((*this).emit_expr(condition))) + std::string(") "));
                (*this).emit_block_or_stmt(then_branch);
                {
                    auto& _match_12 = else_branch;
                ...
                auto& condition = _v.condition;
                auto& body = *_v.body;
                this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("while (")) + ((*this).emit_expr(condition))) + std::string(") "));
                ...
                auto& body = *_v.body;
                {
                    auto& _match_13 = collection;
                    if (std::holds_alternative<Expr::Range>(_match_13._data)) {
                        auto& _v = std::get<Expr::Range>(_match_13._data);
                        auto& start = *_v.start;
                        auto& end = *_v.end;
                        this->output = (((((((((((((this->output + std::string("")) + ((*this).indent())) + std::string("for (int64_t ")) + (item_name.lexeme)) + std::string(" = ")) + ((*this).emit_expr(start))) + std::string("; ")) + (item_name.lexeme)) + std::string(" < ")) + ((*this).emit_expr(end))) + std::string("; ")) + (item_name.lexeme)) + std::string("++) "));
                        (*this).emit_block_or_stmt(body);
                    }
                    else {
                        {
                            auto& _match_14 = collection;
                        ...
                        this->output = (((((((this->output + std::string("")) + ((*this).indent())) + std::string("for (auto& ")) + (item_name.lexeme)) + std::string(" : ")) + ((*this).emit_expr(collection))) + std::string(") "));
                        (*this).emit_block_or_stmt(body);
                    }
                }
            }
    ...
    void emit_let(Token name, TypeNode var_type, Expr initializer, bool in_method) {
        ...
        this->output = (((((((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + (cpp_type)) + std::string(" ")) + (name.lexeme)) + std::string("")) + (init_str)) + std::string(";\n"));
    }
    ...
    void emit_method_block_or_stmt(Stmt s) {
        {
            auto& _match_17 = s;
            if (std::holds_alternative<Stmt::Block>(_match_17._data)) {
                auto& _v = std::get<Stmt::Block>(_match_17._data);
                auto& stmts = _v.statements;
                this->output = (this->output + std::string("{\n"));
                this->indent_level = (this->indent_level + 1LL);
                for (auto& st : stmts) {
    ...
    void emit_function(Token name, std::vector<Param> params, TypeNode return_type, std::vector<Stmt> body) {
        ...
        for (auto& p : params) {
            param_strs.push_back(((((std::string("") + ((*this).emit_type(p.param_type))) + std::string(" ")) + (p.name.lexeme)) + std::string("")));
            {
                auto& _match_18 = p.param_type;
                if (std::holds_alternative<TypeNode::Dynamic>(_match_18._data)) {
        ...
        this->output = (((((((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + (ret_type)) + std::string(" ")) + (name.lexeme)) + std::string("(")) + (lv_join(param_strs, std::string(", ")))) + std::string(") {\n"));
        this->indent_level = (this->indent_level + 1LL);
        for (auto& st : body) {
            (*this).emit_stmt(st);
        }
    ...
    void emit_method_stmt(Stmt s) {
        {
            auto& _match_19 = s;
            if (std::holds_alternative<Stmt::ExprStmt>(_match_19._data)) {
                auto& _v = std::get<Stmt::ExprStmt>(_match_19._data);
                auto& expr = _v.expr;
                this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + ((*this).emit_method_expr(expr))) + std::string(";\n"));
            }
            else if (std::holds_alternative<Stmt::Return>(_match_19._data)) {
                auto& _v = std::get<Stmt::Return>(_match_19._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                {
                    auto& _match_20 = value;
                    if (_match_20._tag == "None") {
                        this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("return;\n"));
                    }
                    else {
                        this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("return ")) + ((*this).emit_method_expr(value))) + std::string(";\n"));
                    }
                }
            }
            else if (std::holds_alternative<Stmt::If>(_match_19._data)) {
                auto& _v = std::get<Stmt::If>(_match_19._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
                this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("if (")) + ((*this).emit_method_expr(condition))) + std::string(") "));
                (*this).emit_method_block_or_stmt(then_branch);
                {
                    auto& _match_21 = else_branch;
                    if (_match_21._tag == "None") {
                        int64_t noop = 0LL;
                    }
                    else {
                        this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string(" else "));
            ...
            else if (std::holds_alternative<Stmt::While>(_match_19._data)) {
                auto& _v = std::get<Stmt::While>(_match_19._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
                this->output = (((((this->output + std::string("")) + ((*this).indent())) + std::string("while (")) + ((*this).emit_method_expr(condition))) + std::string(") "));
                (*this).emit_method_block_or_stmt(body);
            }
            else if (std::holds_alternative<Stmt::For>(_match_19._data)) {
                auto& _v = std::get<Stmt::For>(_match_19._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                {
                    auto& _match_22 = collection;
                    if (std::holds_alternative<Expr::Range>(_match_22._data)) {
                        auto& _v = std::get<Expr::Range>(_match_22._data);
                        auto& start = *_v.start;
                        auto& end = *_v.end;
                        this->output = (((((((((((((this->output + std::string("")) + ((*this).indent())) + std::string("for (int64_t ")) + (item_name.lexeme)) + std::string(" = ")) + ((*this).emit_method_expr(start))) + std::string("; ")) + (item_name.lexeme)) + std::string(" < ")) + ((*this).emit_method_expr(end))) + std::string("; ")) + (item_name.lexeme)) + std::string("++) "));
                        (*this).emit_method_block_or_stmt(body);
                    }
                    else {
                        {
                            auto& _match_23 = collection;
                            if (std::holds_alternative<Expr::Variable>(_match_23._data)) {
                                auto& _v = std::get<Expr::Variable>(_match_23._data);
                                auto& tok = _v.name;
                                if ((*this).is_dynamic_var(tok.lexeme)) {
                                    (*this).add_dynamic_var(item_name.lexeme);
                                }
                        ...
                        this->output = (((((((this->output + std::string("")) + ((*this).indent())) + std::string("for (auto& ")) + (item_name.lexeme)) + std::string(" : ")) + ((*this).emit_method_expr(collection))) + std::string(") "));
                        (*this).emit_method_block_or_stmt(body);
                    }
                }
            }
            else if (std::holds_alternative<Stmt::Let>(_match_19._data)) {
                auto& _v = std::get<Stmt::Let>(_match_19._data);
                auto& name = _v.name;
                auto& var_type = _v.var_type;
                auto& initializer = _v.initializer;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<Stmt::Const>(_match_19._data)) {
                auto& _v = std::get<Stmt::Const>(_match_19._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<Stmt::Block>(_match_19._data)) {
            ...
            else if (std::holds_alternative<Stmt::Try>(_match_19._data)) {
                auto& _v = std::get<Stmt::Try>(_match_19._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("try "));
            ...
            else if (std::holds_alternative<Stmt::Match>(_match_19._data)) {
                auto& _v = std::get<Stmt::Match>(_match_19._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
    ...
    void emit_class(Token name, std::vector<Stmt> body) {
        ...
        for (auto& st : body) {
            {
                auto& _match_24 = st;
                if (std::holds_alternative<Stmt::Function>(_match_24._data)) {
                    auto& _v = std::get<Stmt::Function>(_match_24._data);
                    auto& fname = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& fbody = _v.body;
                ...
                else if (std::holds_alternative<Stmt::Let>(_match_24._data)) {
                    auto& _v = std::get<Stmt::Let>(_match_24._data);
                    auto& fname = _v.name;
                    auto& var_type = _v.var_type;
        ...
        if (has_init) {
            ...
            for (auto& st : init_body) {
                {
                    auto& _match_25 = st;
                    if (std::holds_alternative<Stmt::ExprStmt>(_match_25._data)) {
                        auto& _v = std::get<Stmt::ExprStmt>(_match_25._data);
                        auto& expr = _v.expr;
                        {
                            auto& _match_26 = expr;
                            if (std::holds_alternative<Expr::Set>(_match_26._data)) {
                                auto& _v = std::get<Expr::Set>(_match_26._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    auto& _match_27 = object;
                                    if (std::holds_alternative<Expr::This>(_match_27._data)) {
                                        auto& _v = std::get<Expr::This>(_match_27._data);
                                        auto& kw = _v.keyword;
                                        bool already = false;
                                        for (auto& s : seen) {
                                            if ((s == prop.lexeme)) {
        ...
        if (has_init) {
            ...
            for (auto& st : init_body) {
                {
                    auto& _match_28 = st;
                    if (std::holds_alternative<Stmt::ExprStmt>(_match_28._data)) {
                        auto& _v = std::get<Stmt::ExprStmt>(_match_28._data);
                        auto& expr = _v.expr;
                        bool handled = false;
                        {
                            auto& _match_29 = expr;
                            if (std::holds_alternative<Expr::Set>(_match_29._data)) {
                                auto& _v = std::get<Expr::Set>(_match_29._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    auto& _match_30 = object;
                                    if (std::holds_alternative<Expr::This>(_match_30._data)) {
                                        auto& _v = std::get<Expr::This>(_match_30._data);
                                        auto& kw = _v.keyword;
                                        {
                                            auto& _match_31 = value;
                                            if (std::holds_alternative<Expr::Variable>(_match_31._data)) {
                                                auto& _v = std::get<Expr::Variable>(_match_31._data);
                                                auto& tok = _v.name;
            ...
            if ((static_cast<int64_t>(init_list.size()) == 0LL)) {
                this->output = (((((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + (name.lexeme)) + std::string("(")) + (lv_join(param_strs, std::string(", ")))) + std::string(") {\n"));
            }
             else {
                this->output = (((((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + (name.lexeme)) + std::string("(")) + (lv_join(param_strs, std::string(", ")))) + std::string(")\n"));
        ...
        for (auto& m : methods) {
            {
                auto& _match_32 = m;
                if (std::holds_alternative<Stmt::Function>(_match_32._data)) {
                    auto& _v = std::get<Stmt::Function>(_match_32._data);
                    auto& mname = _v.name;
                    ...
                    for (auto& p : mparams) {
                        mparam_strs.push_back(((((std::string("") + ((*this).emit_type(p.param_type))) + std::string(" ")) + (p.name.lexeme)) + std::string("")));
                        {
                            auto& _match_33 = p.param_type;
                            if (std::holds_alternative<TypeNode::Dynamic>(_match_33._data)) {
                                (*this).add_dynamic_var(p.name.lexeme);
                            }
                            else {
                                int64_t noop = 0LL;
                    ...
                    if ((mname.lexeme == std::string("destructor"))) {
                        ...
                        this->output = (((((((((this->output + std::string("")) + ((*this).indent())) + std::string("")) + (ret_type)) + std::string(" ")) + (mname.lexeme)) + std::string("(")) + (lv_join(mparam_strs, std::string(", ")))) + std::string(") {\n"));
                    }
                    this->indent_level = (this->indent_level + 1LL);
                    for (auto& st : mbody) {
                        (*this).emit_method_stmt(st);
    ...
    std::string infer_expr_type(Expr e, std::vector<std::string> param_names, std::vector<std::string> param_types) {
        {
            auto& _match_34 = e;
            if (std::holds_alternative<Expr::Literal>(_match_34._data)) {
                auto& _v = std::get<Expr::Literal>(_match_34._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                    return std::string("int64_t");
            ...
            else if (std::holds_alternative<Expr::Variable>(_match_34._data)) {
                auto& _v = std::get<Expr::Variable>(_match_34._data);
                auto& tok = _v.name;
            ...
            else if (std::holds_alternative<Expr::Binary>(_match_34._data)) {
                auto& _v = std::get<Expr::Binary>(_match_34._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<Expr::Call>(_match_34._data)) {
                auto& _v = std::get<Expr::Call>(_match_34._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                {
                    auto& _match_35 = callee;
                    if (std::holds_alternative<Expr::Variable>(_match_35._data)) {
                        auto& _v = std::get<Expr::Variable>(_match_35._data);
                        auto& tok = _v.name;
                        if ((*this).is_known_enum(tok.lexeme)) {
                            return tok.lexeme;
                        }
            ...
            else if (std::holds_alternative<Expr::Vector>(_match_34._data)) {
                auto& _v = std::get<Expr::Vector>(_match_34._data);
                auto& elements = _v.elements;
    ...
    void emit_enum(Token name, std::vector<EnumVariantNode> variants) {
        ...
        for (auto& v : variants) {
            for (auto& ft : v.types) {
                {
                    auto& _match_36 = ft;
                    if (std::holds_alternative<TypeNode::Custom>(_match_36._data)) {
                        auto& _v = std::get<TypeNode::Custom>(_match_36._data);
                        auto& n = _v.name;
                        if ((n == enum_name)) {
                            has_self_ref = true;
                        }
        ...
        for (auto& v : variants) {
            if ((static_cast<int64_t>(v.types.size()) > 0LL)) {
                ...
                for (int64_t fi = 0LL; fi < static_cast<int64_t>(v.types.size()); fi++) {
                    ...
                    {
                        auto& _match_37 = v.types[fi];
                        if (std::holds_alternative<TypeNode::Custom>(_match_37._data)) {
            ...
            if ((static_cast<int64_t>(v.types.size()) == 0LL)) {
                ...
                for (int64_t fi = 0LL; fi < static_cast<int64_t>(v.types.size()); fi++) {
                    ...
                    bool is_self_ref = false;
                    {
                        ...
                        if (std::holds_alternative<TypeNode::Custom>(_match_38._data)) {
    ...
    void emit_match_impl(Expr expr, std::vector<MatchArm> arm_patterns, std::vector<Stmt> arm_bodies, bool in_method) {
        ...
        this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("{\n"));
        this->indent_level = (this->indent_level + 1LL);
        this->output = (((((((this->output + std::string("")) + ((*this).indent())) + std::string("auto& ")) + (temp)) + std::string(" = ")) + (match_val)) + std::string(";\n"));
        bool first = true;
                        ...
                        for (int64_t bi = 0LL; bi < static_cast<int64_t>(arm.bindings.size()); bi++) {
                            if ((bi < static_cast<int64_t>(vinfo.field_names.size()))) {
                                ...
                                if ((bi < static_cast<int64_t>(vinfo.types.size()))) {
                                    {
                                        auto& _match_39 = vinfo.types[bi];
                                        if (std::holds_alternative<TypeNode::Custom>(_match_39._data)) {
    ...
    void emit_arm_body(Stmt arm_body, bool in_method) {
        {
            auto& _match_40 = arm_body;
            if (std::holds_alternative<Stmt::Block>(_match_40._data)) {
                auto& _v = std::get<Stmt::Block>(_match_40._data);
                auto& stmts = _v.statements;
                for (auto& st : stmts) {
                    if (in_method) {
                        (*this).emit_method_stmt(st);
    ...
    std::string generate(std::vector<Stmt> stmts) {
        ...
        for (auto& stmt : stmts) {
            {
                auto& _match_41 = stmt;
                if (std::holds_alternative<Stmt::Function>(_match_41._data)) {
                    auto& _v = std::get<Stmt::Function>(_match_41._data);
                    auto& name = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& body = _v.body;
...
struct Parser {
    ...
    Expr assignment() {
        ...
        if ((*this).match_any(std::vector{TK_EQUAL})) {
            ...
            {
                auto& _match_42 = expr;
                if (std::holds_alternative<Expr::Variable>(_match_42._data)) {
                    auto& _v = std::get<Expr::Variable>(_match_42._data);
                    auto& name = _v.name;
                    return Expr::make_Assign(name, value);
                }
                else if (std::holds_alternative<Expr::Get>(_match_42._data)) {
                    auto& _v = std::get<Expr::Get>(_match_42._data);
                    auto& object = *_v.object;
                    auto& name = _v.name;
                    return Expr::make_Set(object, name, value);
                }
                else if (std::holds_alternative<Expr::Index>(_match_42._data)) {
                    auto& _v = std::get<Expr::Index>(_match_42._data);
                    auto& object = *_v.object;
                    auto& bracket = _v.bracket;
                    auto& index = *_v.index;
            ...
            if ((*this).match_any(std::vector{TK_PLUS_EQUAL, TK_MINUS_EQUAL, TK_STAR_EQUAL})) {
                ...
                {
                    auto& _match_43 = expr;
                    if (std::holds_alternative<Expr::Variable>(_match_43._data)) {
                        auto& _v = std::get<Expr::Variable>(_match_43._data);
                        auto& name = _v.name;
                        Expr bin = Expr::make_Binary(Expr::make_Variable(name), op_token, rhs);
                        return Expr::make_Assign(name, bin);
                    }
                    else if (std::holds_alternative<Expr::Get>(_match_43._data)) {
                        auto& _v = std::get<Expr::Get>(_match_43._data);
                        auto& object = *_v.object;
                        auto& name = _v.name;
                        Expr bin = Expr::make_Binary(Expr::make_Get(object, name), op_token, rhs);
                        return Expr::make_Set(object, name, bin);
                    }
                    else if (std::holds_alternative<Expr::Index>(_match_43._data)) {
                        auto& _v = std::get<Expr::Index>(_match_43._data);
                        auto& object = *_v.object;
                        auto& bracket = _v.bracket;
                        auto& index = *_v.index;
    ...
    Expr finish_call(Expr callee) {
        {
            auto& _match_44 = callee;
            if (std::holds_alternative<Expr::Variable>(_match_44._data)) {
                auto& _v = std::get<Expr::Variable>(_match_44._data);
                auto& name = _v.name;
            ...
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).check(TK_IDENTIFIER) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                    ...
                    if ((*this).check(TK_IDENTIFIER) && (((*this).peek_at(1LL).token_type == TK_NEWLINE) || ((*this).peek_at(1LL).token_type == TK_DEDENT))) {
                        ...
                        {
                            auto& _match_45 = vtype;
                            if (std::holds_alternative<TypeNode::NullType>(_match_45._data)) {
                                is_unit_type = true;
                            }
                            else if (std::holds_alternative<TypeNode::Void>(_match_45._data)) {
                                is_unit_type = true;
                            }
                            else {
                                int64_t noop = 0LL;
...
void test_parser() {
    ...
    for (auto& stmt : stmts) {
        {
            auto& _match_46 = stmt;
            if (std::holds_alternative<Stmt::ExprStmt>(_match_46._data)) {
                auto& _v = std::get<Stmt::ExprStmt>(_match_46._data);
                auto& expr = _v.expr;
                {
                    auto& _match_47 = expr;
                    if (std::holds_alternative<Expr::Binary>(_match_47._data)) {
                        ...
                        {
                            auto& _match_48 = right;
                            if (std::holds_alternative<Expr::Binary>(_match_48._data)) {
                                auto& _v = std::get<Expr::Binary>(_match_48._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
