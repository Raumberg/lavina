// Stage 18: operator overloading + auto print
#include "lavina.h"
...
struct CppCodegen {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_35)>::Function>(_match_35._data)) {
                ...
                if ((mname.lexeme == std::string("destructor"))) {
                    ...
                    if ((mname.lexeme == std::string("to_string"))) {
                        this->output = (this->output + ((((((((std::string("") + ((*this).indent())) + std::string("")) + (ret_type)) + std::string(" ")) + (mname.lexeme)) + std::string("(")) + (mparam_str)) + std::string(") const {\n")));
                    }
                    else {
                        ...
                        for (int64_t bi = 0LL; bi < static_cast<int64_t>(arm.bindings.size()); bi++) {
                            if ((bi < static_cast<int64_t>(vinfo.field_names.size()))) {
                                ...
                                if ((bi < static_cast<int64_t>(vinfo.types.size()))) {
                                    {
                                        const auto& _match_47 = vinfo.types[bi];
                                        if (std::holds_alternative<std::decay_t<decltype(_match_47)>::Custom>(_match_47._data)) {
                                            auto& _v = std::get<std::decay_t<decltype(_match_47)>::Custom>(_match_47._data);
                                            auto& n = _v.name;
                                            auto& _ = _v.type_args;
                                            if ((n == ename)) {
                                                is_self_ref = true;
    ...
    void emit_arm_body(const Stmt& arm_body, bool in_method) {
        {
            const auto& _match_48 = arm_body;
            if (std::holds_alternative<std::decay_t<decltype(_match_48)>::Block>(_match_48._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_48)>::Block>(_match_48._data);
                auto& stmts = _v.statements;
                for (const auto& st : stmts) {
        ...
        for (const auto& stmt : stmts) {
            {
                ...
                if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Extern>(_match_49._data)) {
        ...
        for (const auto& stmt : stmts) {
            {
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_50)>::Extern>(_match_50._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_50)>::Extern>(_match_50._data);
                    auto& header = _v.header;
                    auto& link_lib = _v.link_lib;
                    auto& types = _v.types;
                    auto& functions = _v.functions;
...
struct Checker {
    ...
    bool types_compatible(const TypeNode& expected, const TypeNode& actual) {
        {
            const auto& _match_51 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Array>(_match_51._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_51)>::Array>(_match_51._data);
                auto& a_inner = *_v.inner;
                {
                    const auto& _match_52 = a_inner;
                    if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Auto>(_match_52._data)) {
                        {
                            ...
                            else if (std::holds_alternative<std::decay_t<decltype(_match_53)>::HashSet>(_match_53._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_53)>::HashSet>(_match_53._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_53)>::HashMap>(_match_53._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_53)>::HashMap>(_match_53._data);
                                auto& ek = *_v.key_type;
        ...
        }
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_57)>::Dynamic>(_match_57._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_59)>::Int>(_match_59._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_59)>::Int8>(_match_59._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_59)>::Int16>(_match_59._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_59)>::Int32>(_match_59._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_59)>::USize>(_match_59._data)) {
                a_is_int = true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Float>(_match_61._data)) {
                a_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Float32>(_match_61._data)) {
                a_is_float = true;
            }
            else {
                /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_62)>::CString>(_match_62._data)) {
                {
                    const auto& _match_63 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_63)>::Str>(_match_63._data)) {
                        return true;
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_62)>::Str>(_match_62._data)) {
                {
                    const auto& _match_64 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_64)>::CString>(_match_64._data)) {
                        return true;
                    }
                    else {
                        /* pass */
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Nullable>(_match_65._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_65)>::Nullable>(_match_65._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_66 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_66)>::NullType>(_match_66._data)) {
                        return true;
                    }
                    else {
        ...
        {
            const auto& _match_67 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Ptr>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Ptr>(_match_67._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_68 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_68)>::NullType>(_match_68._data)) {
                        return true;
                    }
                    else {
                        /* pass */
    ...
    std::string type_name(const TypeNode& t) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::NullType>(_match_69._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::HashSet>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::HashSet>(_match_69._data);
                auto& inner = *_v.inner;
                return ((std::string("set[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::HashMap>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::HashMap>(_match_69._data);
                auto& k = *_v.key_type;
                auto& v = *_v.value_type;
                return ((((std::string("map[") + ((*this).type_name(k))) + std::string(", ")) + ((*this).type_name(v))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Nullable>(_match_69._data)) {
    ...
    TypeNode infer_type(const Expr& e) {
        {
            const auto& _match_70 = e;
            if (_match_70._tag == "None") {
                return TypeNode::make_None();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Literal>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Literal>(_match_70._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Variable>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Variable>(_match_70._data);
                auto& name = _v.name;
                auto sym = (*this).lookup(name.lexeme);
                return sym.sym_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Binary>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Binary>(_match_70._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                ...
                }
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_71)>::Str>(_match_71._data)) {
                        return TypeNode::make_Str();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_74 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_74)>::Int>(_match_74._data)) {
                        return TypeNode::make_Int();
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Unary>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Unary>(_match_70._data);
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Logical>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Logical>(_match_70._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                return TypeNode::make_Bool();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Call>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Call>(_match_70._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).infer_call_type(callee);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Grouping>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Grouping>(_match_70._data);
                auto& inner = *_v.inner;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Vector>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Vector>(_match_70._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Cast>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Cast>(_match_70._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                return target_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::This>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::This>(_match_70._data);
                auto& kw = _v.keyword;
                return TypeNode::make_Custom(this->current_class_name, {});
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Own>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Own>(_match_70._data);
                auto& expr = *_v.expr;
                return (*this).infer_type(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::AddressOf>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::AddressOf>(_match_70._data);
                auto& expr = *_v.expr;
    ...
    void collect_decl(const Stmt& s) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Function>(_match_78._data)) {
    ...
    void check_stmt(const Stmt& s) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_79)>::ExprStmt>(_match_79._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Let>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Let>(_match_79._data);
                auto& name = _v.name;
                auto& var_type = _v.var_type;
                auto& initializer = _v.initializer;
                auto& visibility = _v.visibility;
                ...
                {
                    const auto& _match_80 = var_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Auto>(_match_80._data)) {
                        /* pass */
                    }
                    else if (_match_80._tag == "None") {
                        /* pass */
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Const>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Const>(_match_79._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Return>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Return>(_match_79._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                (*this).check_expr(value);
                {
                    const auto& _match_81 = this->current_return_type;
                    if (_match_81._tag == "None") {
                        /* pass */
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_81)>::Void>(_match_81._data)) {
                        {
                            const auto& _match_82 = value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::If>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::If>(_match_79._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::While>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::While>(_match_79._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
                (*this).check_expr(condition);
                (*this).check_stmt(body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::For>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::For>(_match_79._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                auto& is_ref = _v.is_ref;
                ...
                {
                    const auto& _match_83 = coll_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_83)>::Array>(_match_83._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_83)>::Array>(_match_83._data);
                        auto& inner = *_v.inner;
                        item_type = inner;
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Block>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Block>(_match_79._data);
                auto& statements = _v.statements;
                (*this).push_scope();
                for (const auto& st : statements) {
                    (*this).check_stmt(st);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Function>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Function>(_match_79._data);
                auto& name = _v.name;
                auto& params = _v.params;
                auto& return_type = _v.return_type;
                auto& body = _v.body;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Class>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Class>(_match_79._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).check_class(name, body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Struct>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Struct>(_match_79._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                auto& struct_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Enum>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Enum>(_match_79._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& visibility = _v.visibility;
                auto& enum_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Match>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Match>(_match_79._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).check_expr(expr);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Try>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Try>(_match_79._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Namespace>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Namespace>(_match_79._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Import>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Import>(_match_79._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Break>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Break>(_match_79._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Continue>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Continue>(_match_79._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Pass>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Pass>(_match_79._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::CppBlock>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::CppBlock>(_match_79._data);
                auto& code = _v.code;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Extern>(_match_79._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_79)>::Extern>(_match_79._data);
                auto& header = _v.header;
                auto& link_lib = _v.link_lib;
                auto& types = _v.types;
                auto& functions = _v.functions;
    ...
    void check_class(const Token& name, const std::vector<Stmt>& body) {
        ...
        for (const auto& s : body) {
            {
                const auto& _match_84 = s;
                if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Function>(_match_84._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_84)>::Function>(_match_84._data);
                    auto& fname = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& fbody = _v.body;
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_84)>::Let>(_match_84._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_84)>::Let>(_match_84._data);
                    auto& lname = _v.name;
                    auto& var_type = _v.var_type;
                    auto& initializer = _v.initializer;
                    auto& visibility = _v.visibility;
    ...
    void check_expr(const Expr& e) {
        {
            const auto& _match_85 = e;
            if (_match_85._tag == "None") {
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Variable>(_match_85._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Binary>(_match_85._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Unary>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Unary>(_match_85._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(right);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Logical>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Logical>(_match_85._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(left);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Grouping>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Grouping>(_match_85._data);
                auto& inner = *_v.inner;
                (*this).check_expr(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Call>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Call>(_match_85._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Assign>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Assign>(_match_85._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(value);
                if ((!(*this).resolve(name.lexeme))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Index>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Index>(_match_85._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::IndexSet>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::IndexSet>(_match_85._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Vector>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Vector>(_match_85._data);
                auto& elements = _v.elements;
                for (const auto& el : elements) {
                    (*this).check_expr(el);
                }
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Map>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Map>(_match_85._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Get>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Get>(_match_85._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Set>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Set>(_match_85._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(object);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::StaticGet>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::StaticGet>(_match_85._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Cast>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Cast>(_match_85._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Throw>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Throw>(_match_85._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Range>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Range>(_match_85._data);
                auto& start = *_v.start;
                auto& end = *_v.end;
                (*this).check_expr(start);
                (*this).check_expr(end);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Lambda>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Lambda>(_match_85._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                (*this).push_scope();
                for (const auto& p : params) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Own>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::Own>(_match_85._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_85)>::AddressOf>(_match_85._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_85)>::AddressOf>(_match_85._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else {
    ...
    void check_call_args(const Expr& callee, const std::vector<Expr>& args, const Token& paren) {
        {
            const auto& _match_86 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Variable>(_match_86._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Variable>(_match_86._data);
                auto& name = _v.name;
                if ((this->known_funcs.count(name.lexeme) > 0)) {
                    ExternFn fi = this->known_funcs[name.lexeme];
...
struct Parser {
    ...
    std::string type_to_string(const TypeNode& t) {
        {
            const auto& _match_87 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Int>(_match_87._data)) {
                return std::string("int64_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Float>(_match_87._data)) {
                return std::string("double");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Str>(_match_87._data)) {
                return std::string("std::string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Bool>(_match_87._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Void>(_match_87._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Auto>(_match_87._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Custom>(_match_87._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_87)>::Custom>(_match_87._data);
                auto& name = _v.name;
                auto& type_args = _v.type_args;
                if ((static_cast<int64_t>(type_args.size()) > 0LL)) {
                    std::vector<std::string> ta = {};
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Array>(_match_87._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Int8>(_match_87._data)) {
                return std::string("int8_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Int16>(_match_87._data)) {
                return std::string("int16_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Int32>(_match_87._data)) {
                return std::string("int32_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Float32>(_match_87._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::USize>(_match_87._data)) {
                return std::string("size_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::CString>(_match_87._data)) {
                return std::string("const char*");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_87)>::Ptr>(_match_87._data)) {
            ...
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).check(TK_IDENTIFIER) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                    ...
                    if ((*this).check(TK_IDENTIFIER) && (((*this).peek_at(1LL).token_type == TK_NEWLINE) || ((*this).peek_at(1LL).token_type == TK_DEDENT))) {
                        ...
                        {
                            const auto& _match_92 = vtype;
                            if (std::holds_alternative<std::decay_t<decltype(_match_92)>::NullType>(_match_92._data)) {
                                is_unit_type = true;
                            }
...
void test_parser() {
    ...
    for (const auto& stmt : stmts) {
        {
            const auto& _match_93 = stmt;
            if (std::holds_alternative<std::decay_t<decltype(_match_93)>::ExprStmt>(_match_93._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_93)>::ExprStmt>(_match_93._data);
                auto& expr = _v.expr;
                {
                    ...
                    if (std::holds_alternative<std::decay_t<decltype(_match_94)>::Binary>(_match_94._data)) {
                        ...
                        {
                            const auto& _match_95 = right;
                            if (std::holds_alternative<std::decay_t<decltype(_match_95)>::Binary>(_match_95._data)) {
