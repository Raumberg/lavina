    ...
    std::string emit_expr(Expr e) {
        {
            ...
            if (_match_2._tag == "None") {
                ...
                auto& expr = *_v.expr;
                return ((std::string("std::move(") + ((*this).emit_expr(expr))) + std::string(")"));
            }
            else {
                return std::string("");
            }
    ...
    std::string emit_method_expr(Expr e) {
        {
            ...
            else if (std::holds_alternative<Expr::Own>(_match_6._data)) {
                auto& _v = std::get<Expr::Own>(_match_6._data);
                auto& expr = *_v.expr;
                return ((std::string("std::move(") + ((*this).emit_method_expr(expr))) + std::string(")"));
            }
            else {
    ...
    void emit_stmt(Stmt s) {
        {
            ...
            if (_match_10._tag == "None") {
                ...
                (*this).emit_let(name, var_type, initializer, false, is_ref);
            }
    ...
    void emit_method_stmt(Stmt s) {
        {
            ...
            if (std::holds_alternative<Stmt::ExprStmt>(_match_19._data)) {
                ...
                auto& visibility = _v.visibility;
                auto& is_ref = _v.is_ref;
                (*this).emit_let(name, var_type, initializer, true, is_ref);
            }
