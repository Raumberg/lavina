...
struct Stmt {
    ...
    struct Function { Token name; std::vector<Param> params; TypeNode return_type; std::vector<Stmt> body; bool is_inline; bool is_comptime; bool is_static; std::string visibility; std::vector<std::string> type_params; };
    ...
    struct Enum { Token name; std::vector<EnumVariantNode> variants; std::string visibility; std::vector<std::string> type_params; };
    ...
    static Stmt make_Function(Token name, std::vector<Param> params, TypeNode return_type, std::vector<Stmt> body, bool is_inline, bool is_comptime, bool is_static, std::string visibility, std::vector<std::string> type_params) { return {"Function", Function{name, params, return_type, body, is_inline, is_comptime, is_static, visibility, type_params}}; }
    ...
    static Stmt make_Enum(Token name, std::vector<EnumVariantNode> variants, std::string visibility, std::vector<std::string> type_params) { return {"Enum", Enum{name, variants, visibility, type_params}}; }
...
struct CppCodegen {
    ...
    bool is_known_enum(const std::string& name) {
        for (const auto& n : this->known_enum_names) {
            if ((n == name)) {
                return true;
            }
        }
        ...
        if ((angle >= 0LL)) {
            ...
            return (*this).is_known_enum(base);
        }
        return false;
    }
    ...
    std::string wrap_extern_arg(std::string expr, const Expr& original, const TypeNode& expected) {
        {
            const auto& _match_1 = original;
            if (std::holds_alternative<std::decay_t<decltype(_match_1)>::Literal>(_match_1._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_1)>::Literal>(_match_1._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("null"))) {
                    {
                        const auto& _match_2 = expected;
                        if (std::holds_alternative<std::decay_t<decltype(_match_2)>::Ptr>(_match_2._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_2)>::Ptr>(_match_2._data);
                            auto& inner = *_v.inner;
                ...
                if ((kind == std::string("string"))) {
                    {
                        ...
                        if (std::holds_alternative<std::decay_t<decltype(_match_3)>::CString>(_match_3._data)) {
                ...
                if ((kind == std::string("float"))) {
                    {
                        ...
                        if (std::holds_alternative<std::decay_t<decltype(_match_5)>::Float32>(_match_5._data)) {
    ...
    std::string emit_type(const TypeNode& t) {
        {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Str>(_match_6._data)) {
                return std::string("std::string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Bool>(_match_6._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Void>(_match_6._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Auto>(_match_6._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Dynamic>(_match_6._data)) {
                return std::string("std::any");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::NullType>(_match_6._data)) {
                return std::string("std::nullptr_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Custom>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::Custom>(_match_6._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Array>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::Array>(_match_6._data);
                auto& inner = *_v.inner;
                return ((std::string("std::vector<") + ((*this).emit_type(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::HashSet>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::HashSet>(_match_6._data);
                auto& inner = *_v.inner;
                return ((std::string("std::unordered_set<") + ((*this).emit_type(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::HashMap>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::HashMap>(_match_6._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Nullable>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::Nullable>(_match_6._data);
                auto& inner = *_v.inner;
                return ((std::string("std::optional<") + ((*this).emit_type(inner))) + std::string(">"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Int8>(_match_6._data)) {
                return std::string("int8_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Int16>(_match_6._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_6)>::Ptr>(_match_6._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_6)>::Ptr>(_match_6._data);
                auto& inner = *_v.inner;
    ...
    std::string emit_expr(const Expr& e, bool m) {
        {
            const auto& _match_7 = e;
            if (_match_7._tag == "None") {
                return std::string("");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Literal>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Literal>(_match_7._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                return (*this).emit_literal(kind, value);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Unary>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Unary>(_match_7._data);
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Binary>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Binary>(_match_7._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Grouping>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Grouping>(_match_7._data);
                auto& inner = *_v.inner;
                return ((std::string("(") + ((*this).emit_expr(inner, m))) + std::string(")"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Variable>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Variable>(_match_7._data);
                auto& name = _v.name;
                return name.lexeme;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Assign>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Assign>(_match_7._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                return ((((std::string("") + (name.lexeme)) + std::string(" = ")) + ((*this).emit_expr(value, m))) + std::string(""));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Logical>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Logical>(_match_7._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                std::string l = (*this).emit_expr(left, m);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Call>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Call>(_match_7._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).emit_call_expr(callee, args, m);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Index>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Index>(_match_7._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::IndexSet>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::IndexSet>(_match_7._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Vector>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Vector>(_match_7._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Map>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Map>(_match_7._data);
                auto& keys = _v.keys;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Get>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Get>(_match_7._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                if (m) {
                    {
                        const auto& _match_8 = object;
                        if (std::holds_alternative<std::decay_t<decltype(_match_8)>::This>(_match_8._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_8)>::This>(_match_8._data);
                            auto& kw = _v.keyword;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Set>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Set>(_match_7._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                if (m) {
                    {
                        const auto& _match_9 = object;
                        if (std::holds_alternative<std::decay_t<decltype(_match_9)>::This>(_match_9._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_9)>::This>(_match_9._data);
                            auto& kw = _v.keyword;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::StaticGet>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::StaticGet>(_match_7._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                if (m) {
                    {
                        const auto& _match_10 = object;
                        if (std::holds_alternative<std::decay_t<decltype(_match_10)>::This>(_match_10._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_10)>::This>(_match_10._data);
                            auto& kw = _v.keyword;
                            return ((std::string("(*this)::") + (name.lexeme)) + std::string(""));
                        }
                        else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::This>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::This>(_match_7._data);
                auto& keyword = _v.keyword;
                return std::string("(*this)");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Cast>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Cast>(_match_7._data);
                auto& expr = *_v.expr;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Throw>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Throw>(_match_7._data);
                auto& expr = *_v.expr;
                return ((std::string("throw std::runtime_error(") + ((*this).emit_expr(expr, m))) + std::string(")"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Lambda>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Lambda>(_match_7._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                return (*this).emit_lambda(params, body, m);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_7)>::Own>(_match_7._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_7)>::Own>(_match_7._data);
                auto& expr = *_v.expr;
    ...
    bool is_dynamic_expression(const Expr& e) {
        {
            const auto& _match_11 = e;
            if (std::holds_alternative<std::decay_t<decltype(_match_11)>::Variable>(_match_11._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_11)>::Variable>(_match_11._data);
                auto& name = _v.name;
                return (*this).is_dynamic_var(name.lexeme);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_11)>::Index>(_match_11._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_11)>::Index>(_match_11._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
    ...
    std::string emit_call_expr(const Expr& callee, const std::vector<Expr>& args, bool in_method) {
        {
            const auto& _match_12 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_12)>::Get>(_match_12._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_12)>::Get>(_match_12._data);
                auto& object = *_v.object;
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_12)>::StaticGet>(_match_12._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_12)>::StaticGet>(_match_12._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                std::string obj = (*this).emit_expr(object, in_method);
                std::vector<std::string> arg_strs = {};
                ...
                {
                    const auto& _match_13 = object;
                    if (std::holds_alternative<std::decay_t<decltype(_match_13)>::Variable>(_match_13._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_13)>::Variable>(_match_13._data);
                        auto& tok = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_12)>::Variable>(_match_12._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_12)>::Variable>(_match_12._data);
                auto& tok = _v.name;
                std::vector<std::string> arg_strs = {};
                for (const auto& a : args) {
                    arg_strs.push_back((*this).emit_expr(a, in_method));
    ...
    std::string emit_params(const std::vector<Param>& params, bool track_dynamic) {
        ...
        for (const auto& p : params) {
            ...
            if (track_dynamic) {
                {
                    const auto& _match_14 = p.param_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_14)>::Dynamic>(_match_14._data)) {
    ...
    void emit_stmt(const Stmt& s, bool m) {
        {
            const auto& _match_15 = s;
            if (_match_15._tag == "None") {
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::ExprStmt>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::ExprStmt>(_match_15._data);
                auto& expr = _v.expr;
                this->output = (this->output + ((((std::string("") + ((*this).indent())) + std::string("")) + ((*this).emit_expr(expr, m))) + std::string(";\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Let>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Let>(_match_15._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Const>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Const>(_match_15._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Return>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Return>(_match_15._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                {
                    const auto& _match_16 = value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::If>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::If>(_match_15._data);
                ...
                {
                    const auto& _match_17 = else_branch;
                    if (_match_17._tag == "None") {
                        /* pass */
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::While>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::While>(_match_15._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::For>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::For>(_match_15._data);
                ...
                auto& is_mut = _v.is_mut;
                {
                    const auto& _match_18 = collection;
                    if (std::holds_alternative<std::decay_t<decltype(_match_18)>::Range>(_match_18._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_18)>::Range>(_match_18._data);
                        auto& start = *_v.start;
                        auto& end = *_v.end;
                        ...
                        {
                            const auto& _match_19 = collection;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Block>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Block>(_match_15._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Try>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Try>(_match_15._data);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Function>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Function>(_match_15._data);
                auto& name = _v.name;
                auto& params = _v.params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Class>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Class>(_match_15._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Struct>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Struct>(_match_15._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                auto& type_params = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Enum>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Enum>(_match_15._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Match>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Match>(_match_15._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).emit_match_impl(expr, arm_patterns, arm_bodies, m);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Namespace>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Namespace>(_match_15._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("// TODO: unsupported namespace\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Import>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Import>(_match_15._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("// TODO: unsupported import\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Break>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Break>(_match_15._data);
                auto& keyword = _v.keyword;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("break;\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Continue>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Continue>(_match_15._data);
                auto& keyword = _v.keyword;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("continue;\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Pass>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Pass>(_match_15._data);
                auto& keyword = _v.keyword;
                this->output = (this->output + ((std::string("") + ((*this).indent())) + std::string("/* pass */\n")));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::CppBlock>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::CppBlock>(_match_15._data);
                auto& code = _v.code;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_15)>::Extern>(_match_15._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_15)>::Extern>(_match_15._data);
    ...
    void emit_let(const Token& name, const TypeNode& var_type, const Expr& initializer, bool in_method, bool is_ref, bool is_mut) {
        ...
        {
            const auto& _match_20 = initializer;
            if (_match_20._tag == "None") {
                ...
                bool is_ptr = false;
                {
                    const auto& _match_21 = var_type;
                    if (std::holds_alternative<std::decay_t<decltype(_match_21)>::Ptr>(_match_21._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_21)>::Ptr>(_match_21._data);
                        auto& inner = *_v.inner;
                        is_ptr = true;
                    }
                    else {
    ...
    void emit_block_or_stmt(const Stmt& s, bool m) {
        {
            const auto& _match_22 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_22)>::Block>(_match_22._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_22)>::Block>(_match_22._data);
    ...
    void emit_function(const Token& name, const std::vector<Param>& params, const TypeNode& return_type, const std::vector<Stmt>& body, const std::vector<std::string>& type_params) {
    ...
    void emit_class(const Token& name, const std::vector<Stmt>& body, const std::vector<std::string>& type_params) {
        ...
        for (const auto& st : body) {
            {
                const auto& _match_23 = st;
                if (std::holds_alternative<std::decay_t<decltype(_match_23)>::Function>(_match_23._data)) {
        ...
        if (has_init) {
            ...
            for (const auto& st : init_body) {
                {
                    const auto& _match_24 = st;
                    if (std::holds_alternative<std::decay_t<decltype(_match_24)>::ExprStmt>(_match_24._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_24)>::ExprStmt>(_match_24._data);
                        auto& expr = _v.expr;
                        {
                            const auto& _match_25 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_25)>::Set>(_match_25._data)) {
        ...
        if (has_init) {
            ...
            for (const auto& st : init_body) {
                {
                    const auto& _match_27 = st;
                    if (std::holds_alternative<std::decay_t<decltype(_match_27)>::ExprStmt>(_match_27._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_27)>::ExprStmt>(_match_27._data);
                        auto& expr = _v.expr;
                        bool handled = false;
                        {
                            const auto& _match_28 = expr;
                            if (std::holds_alternative<std::decay_t<decltype(_match_28)>::Set>(_match_28._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_28)>::Set>(_match_28._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    const auto& _match_29 = object;
                                    if (std::holds_alternative<std::decay_t<decltype(_match_29)>::This>(_match_29._data)) {
                                        auto& _v = std::get<std::decay_t<decltype(_match_29)>::This>(_match_29._data);
                                        auto& kw = _v.keyword;
                                        {
                                            const auto& _match_30 = value;
                                            if (std::holds_alternative<std::decay_t<decltype(_match_30)>::Variable>(_match_30._data)) {
                                                auto& _v = std::get<std::decay_t<decltype(_match_30)>::Variable>(_match_30._data);
                                                auto& tok = _v.name;
        ...
        for (const auto& m : methods) {
            {
                const auto& _match_31 = m;
                if (std::holds_alternative<std::decay_t<decltype(_match_31)>::Function>(_match_31._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_31)>::Function>(_match_31._data);
                    auto& mname = _v.name;
    ...
    std::string infer_expr_type(const Expr& e, const std::vector<std::string>& param_names, const std::vector<std::string>& param_types) {
        {
            const auto& _match_32 = e;
            if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Literal>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Literal>(_match_32._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                    return std::string("int64_t");
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Variable>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Variable>(_match_32._data);
                auto& tok = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Binary>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Binary>(_match_32._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Unary>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Unary>(_match_32._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                return (*this).infer_expr_type(right, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Grouping>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Grouping>(_match_32._data);
                auto& inner = *_v.inner;
                return (*this).infer_expr_type(inner, param_names, param_types);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Call>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Call>(_match_32._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                {
                    const auto& _match_33 = callee;
                    if (std::holds_alternative<std::decay_t<decltype(_match_33)>::Variable>(_match_33._data)) {
                    ...
                    else if (std::holds_alternative<std::decay_t<decltype(_match_33)>::StaticGet>(_match_33._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_33)>::StaticGet>(_match_33._data);
                        auto& object = *_v.object;
                        auto& name = _v.name;
                        {
                            const auto& _match_34 = object;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Vector>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Vector>(_match_32._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Map>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Map>(_match_32._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_32)>::Cast>(_match_32._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_32)>::Cast>(_match_32._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
    ...
    void emit_enum(const Token& name, const std::vector<EnumVariantNode>& variants, const std::vector<std::string>& type_params) {
        ...
        for (const auto& v : variants) {
            for (const auto& ft : v.types) {
                {
                    const auto& _match_35 = ft;
                    if (std::holds_alternative<std::decay_t<decltype(_match_35)>::Custom>(_match_35._data)) {
        ...
        for (const auto& v : variants) {
            if ((static_cast<int64_t>(v.types.size()) > 0LL)) {
                ...
                for (int64_t fi = 0LL; fi < static_cast<int64_t>(v.types.size()); fi++) {
                    ...
                    {
                        const auto& _match_36 = v.types[fi];
                        if (std::holds_alternative<std::decay_t<decltype(_match_36)>::Custom>(_match_36._data)) {
        ...
        for (const auto& v : variants) {
            ...
            if ((static_cast<int64_t>(v.types.size()) == 0LL)) {
                ...
                for (int64_t fi = 0LL; fi < static_cast<int64_t>(v.types.size()); fi++) {
                    ...
                    {
                        const auto& _match_37 = v.types[fi];
                        if (std::holds_alternative<std::decay_t<decltype(_match_37)>::Custom>(_match_37._data)) {
                            auto& _v = std::get<std::decay_t<decltype(_match_37)>::Custom>(_match_37._data);
                            auto& n = _v.name;
                            auto& _ = _v.type_args;
                            if ((n == enum_name)) {
                                is_self_ref = true;
                        ...
                        for (int64_t bi = 0LL; bi < static_cast<int64_t>(arm.bindings.size()); bi++) {
                            if ((bi < static_cast<int64_t>(vinfo.field_names.size()))) {
                                ...
                                if ((bi < static_cast<int64_t>(vinfo.types.size()))) {
                                    {
                                        const auto& _match_38 = vinfo.types[bi];
                                        if (std::holds_alternative<std::decay_t<decltype(_match_38)>::Custom>(_match_38._data)) {
                                            auto& _v = std::get<std::decay_t<decltype(_match_38)>::Custom>(_match_38._data);
                                            auto& n = _v.name;
                                            auto& _ = _v.type_args;
                                            if ((n == ename)) {
                                                is_self_ref = true;
    ...
    void emit_arm_body(const Stmt& arm_body, bool in_method) {
        {
            const auto& _match_39 = arm_body;
            if (std::holds_alternative<std::decay_t<decltype(_match_39)>::Block>(_match_39._data)) {
    ...
    std::string generate(const std::vector<Stmt>& stmts) {
        for (const auto& stmt : stmts) {
            {
                const auto& _match_40 = stmt;
                if (std::holds_alternative<std::decay_t<decltype(_match_40)>::Extern>(_match_40._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_40)>::Extern>(_match_40._data);
                    auto& header = _v.header;
                    auto& link_lib = _v.link_lib;
                    auto& types = _v.types;
                    auto& functions = _v.functions;
        ...
        for (const auto& stmt : stmts) {
            {
                const auto& _match_41 = stmt;
                if (std::holds_alternative<std::decay_t<decltype(_match_41)>::Function>(_match_41._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_41)>::Function>(_match_41._data);
                    auto& name = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& body = _v.body;
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_41)>::Extern>(_match_41._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_41)>::Extern>(_match_41._data);
                    auto& header = _v.header;
                    auto& link_lib = _v.link_lib;
                    auto& types = _v.types;
                    auto& functions = _v.functions;
...
struct Checker {
    ...
    bool resolve(const std::string& name) {
        ...
        for (const auto& n : this->known_func_names) {
            if ((n == name)) {
                return true;
            }
        }
        for (const auto& n : this->known_class_names) {
            if ((n == name)) {
                return true;
            }
        }
    ...
    bool types_compatible(const TypeNode& expected, const TypeNode& actual) {
        {
            const auto& _match_42 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_42)>::Array>(_match_42._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_42)>::Array>(_match_42._data);
                auto& a_inner = *_v.inner;
                {
                    const auto& _match_43 = a_inner;
                    if (std::holds_alternative<std::decay_t<decltype(_match_43)>::Auto>(_match_43._data)) {
                        {
                            const auto& _match_44 = expected;
                            if (std::holds_alternative<std::decay_t<decltype(_match_44)>::Array>(_match_44._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_44)>::Array>(_match_44._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_44)>::HashSet>(_match_44._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_44)>::HashSet>(_match_44._data);
                                auto& e_inner = *_v.inner;
                                return true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_44)>::HashMap>(_match_44._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_44)>::HashMap>(_match_44._data);
                                auto& ek = *_v.key_type;
        ...
        {
            const auto& _match_45 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_45)>::Array>(_match_45._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_45)>::Array>(_match_45._data);
                auto& e_inner = *_v.inner;
                {
                    const auto& _match_46 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_46)>::Array>(_match_46._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_46)>::Array>(_match_46._data);
                        auto& a_inner = *_v.inner;
        ...
        {
            const auto& _match_47 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_47)>::Auto>(_match_47._data)) {
                return true;
            }
            else if (_match_47._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_47)>::Dynamic>(_match_47._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_48 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_48)>::Auto>(_match_48._data)) {
                return true;
            }
            else if (_match_48._tag == "None") {
                return true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_48)>::Dynamic>(_match_48._data)) {
                return true;
            }
            else {
                /* pass */
        ...
        bool a_is_int = false;
        {
            const auto& _match_49 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Int>(_match_49._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Int8>(_match_49._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Int16>(_match_49._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_49)>::Int32>(_match_49._data)) {
                e_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_49)>::USize>(_match_49._data)) {
                e_is_int = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_50 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_50)>::Int>(_match_50._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_50)>::Int8>(_match_50._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_50)>::Int16>(_match_50._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_50)>::Int32>(_match_50._data)) {
                a_is_int = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_50)>::USize>(_match_50._data)) {
                a_is_int = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_51 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Float>(_match_51._data)) {
                e_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_51)>::Float32>(_match_51._data)) {
                e_is_float = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_52 = actual;
            if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Float>(_match_52._data)) {
                a_is_float = true;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_52)>::Float32>(_match_52._data)) {
                a_is_float = true;
            }
            else {
                /* pass */
        ...
        {
            const auto& _match_53 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_53)>::CString>(_match_53._data)) {
                {
                    const auto& _match_54 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_54)>::Str>(_match_54._data)) {
                        return true;
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_53)>::Str>(_match_53._data)) {
                {
                    const auto& _match_55 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_55)>::CString>(_match_55._data)) {
                        return true;
                    }
                    else {
                        /* pass */
        ...
        {
            const auto& _match_56 = expected;
            if (std::holds_alternative<std::decay_t<decltype(_match_56)>::Nullable>(_match_56._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_56)>::Nullable>(_match_56._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_57 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_57)>::NullType>(_match_57._data)) {
                        return true;
                    }
                    else {
        ...
        }
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_58)>::Ptr>(_match_58._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_58)>::Ptr>(_match_58._data);
                auto& inner = *_v.inner;
                {
                    const auto& _match_59 = actual;
                    if (std::holds_alternative<std::decay_t<decltype(_match_59)>::NullType>(_match_59._data)) {
                        return true;
                    }
                    else {
                        /* pass */
    ...
    std::string type_name(const TypeNode& t) {
        {
            const auto& _match_60 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Int>(_match_60._data)) {
                return std::string("int");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Float>(_match_60._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Str>(_match_60._data)) {
                return std::string("string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Bool>(_match_60._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Void>(_match_60._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Auto>(_match_60._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Dynamic>(_match_60._data)) {
                return std::string("dynamic");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::NullType>(_match_60._data)) {
                return std::string("null");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Custom>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Custom>(_match_60._data);
                auto& name = _v.name;
                auto& _ = _v.type_args;
                return name;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Array>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Array>(_match_60._data);
                auto& inner = *_v.inner;
                return ((std::string("vector[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::HashSet>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::HashSet>(_match_60._data);
                auto& inner = *_v.inner;
                return ((std::string("set[") + ((*this).type_name(inner))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::HashMap>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::HashMap>(_match_60._data);
                auto& k = *_v.key_type;
                auto& v = *_v.value_type;
                return ((((std::string("map[") + ((*this).type_name(k))) + std::string(", ")) + ((*this).type_name(v))) + std::string("]"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Nullable>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Nullable>(_match_60._data);
                auto& inner = *_v.inner;
                return ((std::string("") + ((*this).type_name(inner))) + std::string("?"));
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Int8>(_match_60._data)) {
                return std::string("int8");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Int16>(_match_60._data)) {
                return std::string("int16");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Int32>(_match_60._data)) {
                return std::string("int32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Float32>(_match_60._data)) {
                return std::string("float32");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::USize>(_match_60._data)) {
                return std::string("usize");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::CString>(_match_60._data)) {
                return std::string("cstring");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_60)>::Ptr>(_match_60._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_60)>::Ptr>(_match_60._data);
                auto& inner = *_v.inner;
    ...
    TypeNode infer_type(const Expr& e) {
        {
            const auto& _match_61 = e;
            if (_match_61._tag == "None") {
                return TypeNode::make_None();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Literal>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Literal>(_match_61._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Variable>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Variable>(_match_61._data);
                auto& name = _v.name;
                auto sym = (*this).lookup(name.lexeme);
                return sym.sym_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Binary>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Binary>(_match_61._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                ...
                {
                    const auto& _match_62 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_62)>::Str>(_match_62._data)) {
                        return TypeNode::make_Str();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_63 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_63)>::Float>(_match_63._data)) {
                        return TypeNode::make_Float();
                    }
                    else {
                        /* pass */
                ...
                {
                    const auto& _match_65 = lt;
                    if (std::holds_alternative<std::decay_t<decltype(_match_65)>::Int>(_match_65._data)) {
                        return TypeNode::make_Int();
                    }
                    else {
                        /* pass */
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Unary>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Unary>(_match_61._data);
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Logical>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Logical>(_match_61._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                return TypeNode::make_Bool();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Call>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Call>(_match_61._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                return (*this).infer_call_type(callee);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Grouping>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Grouping>(_match_61._data);
                auto& inner = *_v.inner;
                return (*this).infer_type(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Index>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Index>(_match_61._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto ot = (*this).infer_type(object);
                {
                    const auto& _match_66 = ot;
                    if (std::holds_alternative<std::decay_t<decltype(_match_66)>::Array>(_match_66._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_66)>::Array>(_match_66._data);
                        auto& inner = *_v.inner;
                        return inner;
                    }
                    else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Vector>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Vector>(_match_61._data);
                auto& elements = _v.elements;
                if ((static_cast<int64_t>(elements.size()) > 0LL)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Cast>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Cast>(_match_61._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                return target_type;
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::This>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::This>(_match_61._data);
                auto& kw = _v.keyword;
                return TypeNode::make_Custom(this->current_class_name, {});
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_61)>::Own>(_match_61._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_61)>::Own>(_match_61._data);
                auto& expr = *_v.expr;
    ...
    TypeNode infer_call_type(const Expr& callee) {
        {
            const auto& _match_67 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Variable>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Variable>(_match_67._data);
                auto& name = _v.name;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::Get>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::Get>(_match_67._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                return TypeNode::make_Auto();
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_67)>::StaticGet>(_match_67._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_67)>::StaticGet>(_match_67._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                {
                    const auto& _match_68 = object;
                    if (std::holds_alternative<std::decay_t<decltype(_match_68)>::Variable>(_match_68._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_68)>::Variable>(_match_68._data);
    ...
    void collect_decl(const Stmt& s) {
        {
            ...
            if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Function>(_match_69._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_69)>::Namespace>(_match_69._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_69)>::Namespace>(_match_69._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                ...
                auto& functions = _v.functions;
                for (const auto& et : types) {
                    this->known_class_names.push_back(et.lavina_name);
                    std::vector<Stmt> empty_body = {};
                    this->known_class_bodies.push_back(empty_body);
                }
                for (const auto& ef : functions) {
                    this->known_func_names.push_back(ef.name);
                    this->known_func_return_types.push_back(ef.return_type);
                    this->known_func_params.push_back(ef.params);
                }
            }
            else {
                /* pass */
    ...
    void check_stmt(const Stmt& s) {
        {
            const auto& _match_70 = s;
            if (std::holds_alternative<std::decay_t<decltype(_match_70)>::ExprStmt>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::ExprStmt>(_match_70._data);
                auto& expr = _v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Let>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Let>(_match_70._data);
                auto& name = _v.name;
                auto& var_type = _v.var_type;
                auto& initializer = _v.initializer;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Const>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Const>(_match_70._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Return>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Return>(_match_70._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                (*this).check_expr(value);
                {
                    const auto& _match_72 = this->current_return_type;
                    if (_match_72._tag == "None") {
                        /* pass */
                    }
                    else if (std::holds_alternative<std::decay_t<decltype(_match_72)>::Void>(_match_72._data)) {
                        {
                            const auto& _match_73 = value;
                            if (_match_73._tag == "None") {
                                /* pass */
                            }
                            else {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::If>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::If>(_match_70._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::While>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::While>(_match_70._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
                (*this).check_expr(condition);
                (*this).check_stmt(body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::For>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::For>(_match_70._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                auto& is_ref = _v.is_ref;
                ...
                {
                    const auto& _match_74 = coll_type;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Block>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Block>(_match_70._data);
                auto& statements = _v.statements;
                (*this).push_scope();
                for (const auto& st : statements) {
                    (*this).check_stmt(st);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Function>(_match_70._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Class>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Class>(_match_70._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).check_class(name, body);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Struct>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Struct>(_match_70._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                auto& struct_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Enum>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Enum>(_match_70._data);
                auto& name = _v.name;
                auto& variants = _v.variants;
                auto& visibility = _v.visibility;
                auto& enum_tp = _v.type_params;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Match>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Match>(_match_70._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
                (*this).check_expr(expr);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Try>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Try>(_match_70._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Namespace>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Namespace>(_match_70._data);
                auto& name = _v.name;
                auto& body = _v.body;
                auto& visibility = _v.visibility;
                (*this).push_scope();
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Import>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Import>(_match_70._data);
                auto& path = _v.path;
                auto& alias = _v.alias;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Break>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Break>(_match_70._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Continue>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Continue>(_match_70._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::Pass>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::Pass>(_match_70._data);
                auto& keyword = _v.keyword;
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_70)>::CppBlock>(_match_70._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_70)>::CppBlock>(_match_70._data);
                auto& code = _v.code;
                /* pass */
            }
        ...
        for (const auto& s : body) {
            {
                ...
                else if (std::holds_alternative<std::decay_t<decltype(_match_75)>::Let>(_match_75._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_75)>::Let>(_match_75._data);
                    auto& lname = _v.name;
                    auto& var_type = _v.var_type;
                    auto& initializer = _v.initializer;
                    auto& visibility = _v.visibility;
    ...
    void check_expr(const Expr& e) {
        {
            const auto& _match_76 = e;
            if (_match_76._tag == "None") {
                /* pass */
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Variable>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Variable>(_match_76._data);
                auto& name = _v.name;
                if ((!(*this).resolve(name.lexeme))) {
                    (*this).error(((std::string("Undefined variable '") + (name.lexeme)) + std::string("'")), name);
                }
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Binary>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Binary>(_match_76._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Unary>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Unary>(_match_76._data);
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(right);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Logical>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Logical>(_match_76._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
                (*this).check_expr(left);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Grouping>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Grouping>(_match_76._data);
                auto& inner = *_v.inner;
                (*this).check_expr(inner);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Call>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Call>(_match_76._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Assign>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Assign>(_match_76._data);
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(value);
                if ((!(*this).resolve(name.lexeme))) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Index>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Index>(_match_76._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::IndexSet>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::IndexSet>(_match_76._data);
                auto& object = *_v.object;
                auto& bracket = _v.bracket;
                auto& index = *_v.index;
                auto& value = *_v.value;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Vector>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Vector>(_match_76._data);
                auto& elements = _v.elements;
                for (const auto& el : elements) {
                    (*this).check_expr(el);
                }
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Map>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Map>(_match_76._data);
                auto& keys = _v.keys;
                auto& values = _v.values;
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Get>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Get>(_match_76._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Set>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Set>(_match_76._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                auto& value = *_v.value;
                (*this).check_expr(object);
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::StaticGet>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::StaticGet>(_match_76._data);
                auto& object = *_v.object;
                auto& name = _v.name;
                (*this).check_expr(object);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Cast>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Cast>(_match_76._data);
                auto& expr = *_v.expr;
                auto& target_type = _v.target_type;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Throw>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Throw>(_match_76._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Range>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Range>(_match_76._data);
                auto& start = *_v.start;
                auto& end = *_v.end;
                (*this).check_expr(start);
                (*this).check_expr(end);
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Lambda>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Lambda>(_match_76._data);
                auto& params = _v.params;
                auto& body = *_v.body;
                (*this).push_scope();
                for (const auto& p : params) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_76)>::Own>(_match_76._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_76)>::Own>(_match_76._data);
                auto& expr = *_v.expr;
                (*this).check_expr(expr);
            }
            else {
    ...
    void check_call_args(const Expr& callee, const std::vector<Expr>& args, const Token& paren) {
        {
            const auto& _match_77 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_77)>::Variable>(_match_77._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_77)>::Variable>(_match_77._data);
                auto& name = _v.name;
                for (int64_t i = 0LL; i < static_cast<int64_t>(this->known_func_names.size()); i++) {
                    if ((this->known_func_names[i] == name.lexeme)) {
...
struct Parser {
    ...
    std::string type_to_string(const TypeNode& t) {
        {
            const auto& _match_78 = t;
            if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Int>(_match_78._data)) {
                return std::string("int64_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Float>(_match_78._data)) {
                return std::string("double");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Str>(_match_78._data)) {
                return std::string("std::string");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Bool>(_match_78._data)) {
                return std::string("bool");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Void>(_match_78._data)) {
                return std::string("void");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Auto>(_match_78._data)) {
                return std::string("auto");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Custom>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Custom>(_match_78._data);
                auto& name = _v.name;
                auto& type_args = _v.type_args;
                if ((static_cast<int64_t>(type_args.size()) > 0LL)) {
                    std::vector<std::string> ta = {};
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Array>(_match_78._data)) {
            ...
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Float32>(_match_78._data)) {
                return std::string("float");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::USize>(_match_78._data)) {
                return std::string("size_t");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::CString>(_match_78._data)) {
                return std::string("const char*");
            }
            else if (std::holds_alternative<std::decay_t<decltype(_match_78)>::Ptr>(_match_78._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_78)>::Ptr>(_match_78._data);
                auto& inner = *_v.inner;
    ...
    Expr assignment() {
        ...
        if ((*this).match_any(std::vector{TK_EQUAL})) {
            ...
            {
                const auto& _match_79 = expr;
                if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Variable>(_match_79._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_79)>::Variable>(_match_79._data);
                    auto& name = _v.name;
                    return Expr::make_Assign(name, value);
                }
                else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Get>(_match_79._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_79)>::Get>(_match_79._data);
                    auto& object = *_v.object;
                    auto& name = _v.name;
                    return Expr::make_Set(object, name, value);
                }
                else if (std::holds_alternative<std::decay_t<decltype(_match_79)>::Index>(_match_79._data)) {
                    auto& _v = std::get<std::decay_t<decltype(_match_79)>::Index>(_match_79._data);
                    auto& object = *_v.object;
                    auto& bracket = _v.bracket;
                    auto& index = *_v.index;
            ...
            if ((*this).match_any(std::vector{TK_PLUS_EQUAL, TK_MINUS_EQUAL, TK_STAR_EQUAL})) {
                ...
                auto op_token = Token(base_type, base_lexeme, compound_op.line, compound_op.col);
                {
                    ...
                    else if (std::holds_alternative<std::decay_t<decltype(_match_80)>::Index>(_match_80._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_80)>::Index>(_match_80._data);
                        auto& object = *_v.object;
                        auto& bracket = _v.bracket;
                        auto& index = *_v.index;
    ...
    Expr finish_call(const Expr& callee) {
        {
            const auto& _match_82 = callee;
            if (std::holds_alternative<std::decay_t<decltype(_match_82)>::Variable>(_match_82._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_82)>::Variable>(_match_82._data);
                auto& name = _v.name;
    ...
    Stmt function_declaration(std::string visibility, bool is_static) {
        ...
        std::vector<Stmt> body = (*this).block();
        return Stmt::make_Function(name, params, return_type, body, is_inline, is_comptime, is_static, visibility, type_params);
    }
    ...
    Stmt enum_declaration(std::string visibility) {
            ...
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).check(TK_IDENTIFIER) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                    ...
                    if ((*this).check(TK_IDENTIFIER) && (((*this).peek_at(1LL).token_type == TK_NEWLINE) || ((*this).peek_at(1LL).token_type == TK_DEDENT))) {
                        ...
                        {
                            const auto& _match_83 = vtype;
                            if (std::holds_alternative<std::decay_t<decltype(_match_83)>::NullType>(_match_83._data)) {
                                is_unit_type = true;
                            }
                            else if (std::holds_alternative<std::decay_t<decltype(_match_83)>::Void>(_match_83._data)) {
                                is_unit_type = true;
                            }
                            else {
                                /* pass */
        ...
        return Stmt::make_Enum(name, variants, visibility, type_params);
    }
    ...
    Stmt declaration() {
        ...
        if (this->in_class_body && (*this).check(TK_IDENTIFIER)) {
            ...
            if (((ctor_name == std::string("constructor")) || (ctor_name == std::string("destructor"))) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                ...
                std::vector<Stmt> body = (*this).block();
                std::vector<std::string> empty_tp = {};
                return Stmt::make_Function(name_tok, params, TypeNode::make_Void(), body, false, false, is_static, visibility, empty_tp);
            }
        }
...
void test_parser() {
    ...
    for (const auto& stmt : stmts) {
        {
            const auto& _match_84 = stmt;
            if (std::holds_alternative<std::decay_t<decltype(_match_84)>::ExprStmt>(_match_84._data)) {
                auto& _v = std::get<std::decay_t<decltype(_match_84)>::ExprStmt>(_match_84._data);
                auto& expr = _v.expr;
                {
                    const auto& _match_85 = expr;
                    if (std::holds_alternative<std::decay_t<decltype(_match_85)>::Binary>(_match_85._data)) {
                        auto& _v = std::get<std::decay_t<decltype(_match_85)>::Binary>(_match_85._data);
                        auto& left = *_v.left;
                        auto& op = _v.op;
                        auto& right = *_v.right;
                        print((std::string("Binary: ") + op.lexeme));
                        {
                            const auto& _match_86 = right;
                            if (std::holds_alternative<std::decay_t<decltype(_match_86)>::Binary>(_match_86._data)) {
                                auto& _v = std::get<std::decay_t<decltype(_match_86)>::Binary>(_match_86._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
    ...
    std::string resolve(std::string file_path) {
        ...
        for (const auto& line : lines) {
            ...
            if (trimmed.starts_with(std::string("import "))) {
                ...
                std::string module_path = ((((std::string("") + (dir)) + std::string("")) + (module_name)) + std::string(".lv"));
