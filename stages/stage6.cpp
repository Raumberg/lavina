// Stage 6: use for ref in compiler source
#include "lavina.h"
...
struct CppCodegen {
    ...
    void emit_function(const Token& name, const std::vector<Param>& params, const TypeNode& return_type, const std::vector<Stmt>& body) {
    ...
    void emit_class(const Token& name, const std::vector<Stmt>& body) {
    ...
    void emit_enum(const Token& name, const std::vector<EnumVariantNode>& variants) {
