...
struct CppCodegen {
    ...
    void emit_stmt(Stmt s, bool m) {
        {
            ...
            if (_match_9._tag == "None") {
                ...
                {
                    const auto& _match_11 = else_branch;
                ...
                auto& body = *_v.body;
                {
                    const auto& _match_12 = collection;
    ...
    void emit_let(Token name, TypeNode var_type, Expr initializer, bool in_method, bool is_ref) {
        ...
        {
            const auto& _match_14 = initializer;
    ...
    void emit_function(Token name, std::vector<Param> params, TypeNode return_type, std::vector<Stmt> body) {
        ...
        for (auto& p : params) {
            ...
            {
                const auto& _match_16 = p.param_type;
        ...
        for (auto& m : methods) {
            {
                ...
                if (std::holds_alternative<Stmt::Function>(_match_25._data)) {
                    ...
                    for (auto& p : mparams) {
                        ...
                        {
                            const auto& _match_26 = p.param_type;
