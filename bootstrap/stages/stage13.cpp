// Stage 13: enum std::holds_alternative for match dispatch, unit variant inner structs,
// recursive skip_type_tokens for nested generics, scoped dynamic_vars, try/catch in main,
// improved infer_expr_type (Binary/Call), removed _tag access in parser enum parsing
#include "lavina.h"
...
struct Expr {
    ...
    std::string _tag;
    std::variant<Expr::None, Expr::Literal, Expr::Unary, Expr::Binary, Expr::Grouping, Expr::Variable, Expr::Assign, Expr::Logical, Expr::Call, Expr::Index, Expr::IndexSet, Expr::Vector, Expr::Map, Expr::Get, Expr::Set, Expr::StaticGet, Expr::This, Expr::Cast, Expr::Throw> _data;
...
struct CppCodegen {
    ...
    void emit_stmt(Stmt s) {
        {
            ...
            if (_match_10._tag == "None") {
                ...
                auto& body = *_v.body;
                {
                    ...
                    if (std::holds_alternative<Expr::Variable>(_match_13._data)) {
                        auto& _v = std::get<Expr::Variable>(_match_13._data);
                        auto& tok = _v.name;
    ...
    void emit_block_or_stmt(Stmt s) {
        {
            auto& _match_15 = s;
            if (std::holds_alternative<Stmt::Block>(_match_15._data)) {
                auto& _v = std::get<Stmt::Block>(_match_15._data);
    ...
    void emit_function(Token name, std::vector<Param> params, TypeNode return_type, std::vector<Stmt> body) {
        ...
        for (auto& p : params) {
            ...
            {
                auto& _match_17 = p.param_type;
                if (std::holds_alternative<TypeNode::Dynamic>(_match_17._data)) {
    ...
    void emit_method_stmt(Stmt s) {
        {
            ...
            else if (std::holds_alternative<Stmt::Return>(_match_18._data)) {
                auto& _v = std::get<Stmt::Return>(_match_18._data);
                auto& keyword = _v.keyword;
                auto& value = _v.value;
                {
                    auto& _match_19 = value;
                    if (_match_19._tag == "None") {
                        this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("return;\n"));
                    }
                    else {
            ...
            else if (std::holds_alternative<Stmt::If>(_match_18._data)) {
                auto& _v = std::get<Stmt::If>(_match_18._data);
                auto& condition = _v.condition;
                auto& then_branch = *_v.then_branch;
                auto& else_branch = *_v.else_branch;
            ...
            else if (std::holds_alternative<Stmt::While>(_match_18._data)) {
                auto& _v = std::get<Stmt::While>(_match_18._data);
                auto& condition = _v.condition;
                auto& body = *_v.body;
            ...
            else if (std::holds_alternative<Stmt::For>(_match_18._data)) {
                auto& _v = std::get<Stmt::For>(_match_18._data);
                auto& item_name = _v.item_name;
                auto& collection = _v.collection;
                auto& body = *_v.body;
                {
                    auto& _match_21 = collection;
                    if (std::holds_alternative<Expr::Variable>(_match_21._data)) {
                        auto& _v = std::get<Expr::Variable>(_match_21._data);
                        auto& tok = _v.name;
                        if ((*this).is_dynamic_var(tok.lexeme)) {
                            (*this).add_dynamic_var(item_name.lexeme);
                        }
            ...
            else if (std::holds_alternative<Stmt::Let>(_match_18._data)) {
                auto& _v = std::get<Stmt::Let>(_match_18._data);
                auto& name = _v.name;
                auto& var_type = _v.var_type;
                auto& initializer = _v.initializer;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<Stmt::Const>(_match_18._data)) {
                auto& _v = std::get<Stmt::Const>(_match_18._data);
                auto& name = _v.name;
                auto& const_type = _v.const_type;
                auto& value = _v.value;
                auto& visibility = _v.visibility;
            ...
            else if (std::holds_alternative<Stmt::Block>(_match_18._data)) {
                auto& _v = std::get<Stmt::Block>(_match_18._data);
                auto& stmts = _v.statements;
                this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("{\n"));
                this->indent_level = (this->indent_level + 1LL);
                for (auto& st : stmts) {
            ...
            else if (std::holds_alternative<Stmt::Try>(_match_18._data)) {
                auto& _v = std::get<Stmt::Try>(_match_18._data);
                auto& try_body = *_v.try_body;
                auto& catch_body = *_v.catch_body;
                auto& exception_name = _v.exception_name;
                this->output = (((this->output + std::string("")) + ((*this).indent())) + std::string("try "));
            ...
            else if (std::holds_alternative<Stmt::Match>(_match_18._data)) {
                auto& _v = std::get<Stmt::Match>(_match_18._data);
                auto& expr = _v.expr;
                auto& arm_patterns = _v.arm_patterns;
                auto& arm_bodies = _v.arm_bodies;
    ...
    void emit_class(Token name, std::vector<Stmt> body) {
        ...
        for (auto& st : body) {
            {
                auto& _match_22 = st;
                if (std::holds_alternative<Stmt::Function>(_match_22._data)) {
                    auto& _v = std::get<Stmt::Function>(_match_22._data);
                    auto& fname = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& fbody = _v.body;
                ...
                else if (std::holds_alternative<Stmt::Let>(_match_22._data)) {
        ...
        if (has_init) {
            ...
            for (auto& st : init_body) {
                {
                    auto& _match_23 = st;
                    if (std::holds_alternative<Stmt::ExprStmt>(_match_23._data)) {
                        auto& _v = std::get<Stmt::ExprStmt>(_match_23._data);
                        auto& expr = _v.expr;
                        {
                            auto& _match_24 = expr;
                            if (std::holds_alternative<Expr::Set>(_match_24._data)) {
                                auto& _v = std::get<Expr::Set>(_match_24._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    auto& _match_25 = object;
                                    if (std::holds_alternative<Expr::This>(_match_25._data)) {
                                        auto& _v = std::get<Expr::This>(_match_25._data);
                                        auto& kw = _v.keyword;
                                        bool already = false;
                                        for (auto& s : seen) {
                                            if ((s == prop.lexeme)) {
        ...
        if (has_init) {
            ...
            for (auto& st : init_body) {
                {
                    auto& _match_26 = st;
                    if (std::holds_alternative<Stmt::ExprStmt>(_match_26._data)) {
                        auto& _v = std::get<Stmt::ExprStmt>(_match_26._data);
                        auto& expr = _v.expr;
                        bool handled = false;
                        {
                            auto& _match_27 = expr;
                            if (std::holds_alternative<Expr::Set>(_match_27._data)) {
                                auto& _v = std::get<Expr::Set>(_match_27._data);
                                auto& object = *_v.object;
                                auto& prop = _v.name;
                                auto& value = *_v.value;
                                {
                                    auto& _match_28 = object;
                                    if (std::holds_alternative<Expr::This>(_match_28._data)) {
                                        auto& _v = std::get<Expr::This>(_match_28._data);
                                        auto& kw = _v.keyword;
                                        {
                                            auto& _match_29 = value;
                                            if (std::holds_alternative<Expr::Variable>(_match_29._data)) {
                                                auto& _v = std::get<Expr::Variable>(_match_29._data);
                                                auto& tok = _v.name;
        ...
        for (auto& m : methods) {
            {
                auto& _match_30 = m;
                if (std::holds_alternative<Stmt::Function>(_match_30._data)) {
                    auto& _v = std::get<Stmt::Function>(_match_30._data);
                    auto& mname = _v.name;
                    ...
                    for (auto& p : mparams) {
                        ...
                        {
                            auto& _match_31 = p.param_type;
                            if (std::holds_alternative<TypeNode::Dynamic>(_match_31._data)) {
                                (*this).add_dynamic_var(p.name.lexeme);
                            }
                            else {
                                int64_t noop = 0LL;
    ...
    std::string infer_expr_type(Expr e, std::vector<std::string> param_names, std::vector<std::string> param_types) {
        {
            auto& _match_32 = e;
            if (std::holds_alternative<Expr::Literal>(_match_32._data)) {
                auto& _v = std::get<Expr::Literal>(_match_32._data);
                auto& kind = _v.kind;
                auto& value = _v.value;
                if ((kind == std::string("int"))) {
                    return std::string("int64_t");
            ...
            else if (std::holds_alternative<Expr::Variable>(_match_32._data)) {
                auto& _v = std::get<Expr::Variable>(_match_32._data);
                auto& tok = _v.name;
                int64_t i = 0LL;
            ...
            else if (std::holds_alternative<Expr::Binary>(_match_32._data)) {
                auto& _v = std::get<Expr::Binary>(_match_32._data);
                auto& left = *_v.left;
                auto& op = _v.op;
                auto& right = *_v.right;
            ...
            else if (std::holds_alternative<Expr::Call>(_match_32._data)) {
                auto& _v = std::get<Expr::Call>(_match_32._data);
                auto& callee = *_v.callee;
                auto& paren = _v.paren;
                auto& args = _v.args;
                {
                    auto& _match_33 = callee;
                    if (std::holds_alternative<Expr::Variable>(_match_33._data)) {
            ...
            else if (std::holds_alternative<Expr::Vector>(_match_32._data)) {
                auto& _v = std::get<Expr::Vector>(_match_32._data);
                auto& elements = _v.elements;
    ...
    void emit_enum(Token name, std::vector<EnumVariantNode> variants) {
        ...
        for (auto& v : variants) {
            for (auto& ft : v.types) {
                {
                    auto& _match_34 = ft;
                    if (std::holds_alternative<TypeNode::Custom>(_match_34._data)) {
                        auto& _v = std::get<TypeNode::Custom>(_match_34._data);
                        auto& n = _v.name;
                        if ((n == enum_name)) {
                            has_self_ref = true;
                        }
        ...
        for (auto& v : variants) {
            if ((static_cast<int64_t>(v.types.size()) > 0LL)) {
                ...
                while ((fi < static_cast<int64_t>(v.types.size()))) {
                    ...
                    {
                        auto& _match_35 = v.types[fi];
                        if (std::holds_alternative<TypeNode::Custom>(_match_35._data)) {
                            auto& _v = std::get<TypeNode::Custom>(_match_35._data);
                            auto& n = _v.name;
                            if ((n == enum_name)) {
    ...
    void emit_arm_body(Stmt arm_body, bool in_method) {
        {
            auto& _match_38 = arm_body;
            if (std::holds_alternative<Stmt::Block>(_match_38._data)) {
                auto& _v = std::get<Stmt::Block>(_match_38._data);
                auto& stmts = _v.statements;
                for (auto& st : stmts) {
                    if (in_method) {
                        (*this).emit_method_stmt(st);
    ...
    std::string generate(std::vector<Stmt> stmts) {
        ...
        for (auto& stmt : stmts) {
            {
                auto& _match_39 = stmt;
                if (std::holds_alternative<Stmt::Function>(_match_39._data)) {
                    auto& _v = std::get<Stmt::Function>(_match_39._data);
                    auto& name = _v.name;
                    auto& params = _v.params;
                    auto& return_type = _v.return_type;
                    auto& body = _v.body;
...
struct Parser {
    ...
    Expr assignment() {
        ...
        if ((*this).match_any(std::vector{TK_EQUAL})) {
            ...
            {
                auto& _match_40 = expr;
                if (std::holds_alternative<Expr::Variable>(_match_40._data)) {
                    auto& _v = std::get<Expr::Variable>(_match_40._data);
                    auto& name = _v.name;
                    return Expr::make_Assign(name, value);
                }
                else if (std::holds_alternative<Expr::Get>(_match_40._data)) {
                    auto& _v = std::get<Expr::Get>(_match_40._data);
                    auto& object = *_v.object;
                    auto& name = _v.name;
                    return Expr::make_Set(object, name, value);
                }
                else if (std::holds_alternative<Expr::Index>(_match_40._data)) {
                    auto& _v = std::get<Expr::Index>(_match_40._data);
                    auto& object = *_v.object;
                    auto& bracket = _v.bracket;
                    auto& index = *_v.index;
    ...
    Expr finish_call(Expr callee) {
        {
            auto& _match_41 = callee;
            if (std::holds_alternative<Expr::Variable>(_match_41._data)) {
                auto& _v = std::get<Expr::Variable>(_match_41._data);
                auto& name = _v.name;
            ...
            if ((*this).match_any(std::vector{TK_NEWLINE})) {
                ...
                if ((*this).check(TK_IDENTIFIER) && ((*this).peek_at(1LL).token_type == TK_LEFT_PAREN)) {
                    ...
                    if ((*this).check(TK_IDENTIFIER) && (((*this).peek_at(1LL).token_type == TK_NEWLINE) || ((*this).peek_at(1LL).token_type == TK_DEDENT))) {
                        ...
                        {
                            auto& _match_42 = vtype;
                            if (std::holds_alternative<TypeNode::NullType>(_match_42._data)) {
                                is_unit_type = true;
                            }
                            else if (std::holds_alternative<TypeNode::Void>(_match_42._data)) {
                                is_unit_type = true;
                            }
                            else {
                                int64_t noop = 0LL;
...
void test_parser() {
    ...
    for (auto& stmt : stmts) {
        {
            auto& _match_43 = stmt;
            if (std::holds_alternative<Stmt::ExprStmt>(_match_43._data)) {
                auto& _v = std::get<Stmt::ExprStmt>(_match_43._data);
                auto& expr = _v.expr;
                {
                    auto& _match_44 = expr;
                    if (std::holds_alternative<Expr::Binary>(_match_44._data)) {
                        auto& _v = std::get<Expr::Binary>(_match_44._data);
                        auto& left = *_v.left;
                        auto& op = _v.op;
                        auto& right = *_v.right;
                        print((std::string("Binary: ") + op.lexeme));
                        {
                            auto& _match_45 = right;
                            if (std::holds_alternative<Expr::Binary>(_match_45._data)) {
                                auto& _v = std::get<Expr::Binary>(_match_45._data);
                                auto& rl = *_v.left;
                                auto& rop = _v.op;
                                auto& rr = *_v.right;
