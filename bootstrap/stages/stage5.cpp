// Stage 5: Language improvements
// - String interpolation with ${expr} syntax
// - Modulo operator %
// - elif keyword
// - constructor() instead of __init__() (both supported)
// - Removed extra parentheses from codegen (cleaner C++ output)
#include "lavina.h"
        ...
        for (auto& st : body) {
            {
                ...
                if (_match_26._tag == "Function") {
                    ...
                    auto& is_static = _v.is_static;
                    auto& visibility = _v.visibility;
                    if (fname.lexeme == std::string("constructor") || fname.lexeme == std::string("__init__")) {
                        has_init = true;
                        init_body = fbody;
                        init_params = params;
                    }
